  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AddDataSourceRequest.t ->
        (AddDataSourceResponse.t, AddDataSourceResponse.error) Result.t Lwt.t
val add_direct_query_data_source :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AddDirectQueryDataSourceRequest.t ->
        (AddDirectQueryDataSourceResponse.t,
          AddDirectQueryDataSourceResponse.error) Result.t Lwt.t
val add_tags :
  ?endpoint_url:string ->
...
val delete_direct_query_data_source :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDirectQueryDataSourceRequest.t -> (unit, unit) Result.t Lwt.t
val delete_domain :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDryRunProgressRequest.t ->
        (DescribeDryRunProgressResponse.t,
          DescribeDryRunProgressResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeInsightDetailsRequest.t ->
        (DescribeInsightDetailsResponse.t,
          DescribeInsightDetailsResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetCapabilityRequest.t ->
        (GetCapabilityResponse.t, GetCapabilityResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListDirectQueryDataSourcesRequest.t ->
        (ListDirectQueryDataSourcesResponse.t,
          ListDirectQueryDataSourcesResponse.error) Result.t Lwt.t
val list_domain_maintenances :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListDomainMaintenancesRequest.t ->
        (ListDomainMaintenancesResponse.t,
          ListDomainMaintenancesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      PutDefaultApplicationSettingRequest.t ->
        (PutDefaultApplicationSettingResponse.t,
          PutDefaultApplicationSettingResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      RollbackServiceSoftwareUpdateRequest.t ->
        (RollbackServiceSoftwareUpdateResponse.t,
          RollbackServiceSoftwareUpdateResponse.error) Result.t Lwt.t
val start_domain_maintenance :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartDomainMaintenanceRequest.t ->
        (StartDomainMaintenanceResponse.t,
          StartDomainMaintenanceResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateDirectQueryDataSourceRequest.t ->
        (UpdateDirectQueryDataSourceResponse.t,
          UpdateDirectQueryDataSourceResponse.error) Result.t Lwt.t
