    ...
    ?cfg:Awso.Cfg.t ->
      CreateDBClusterEndpointMessage.t ->
        (CreateDBClusterEndpointOutput.t,
          CreateDBClusterEndpointOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDBClusterEndpointMessage.t ->
        (DeleteDBClusterEndpointOutput.t,
          DeleteDBClusterEndpointOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyDBClusterEndpointMessage.t ->
        (ModifyDBClusterEndpointOutput.t,
          ModifyDBClusterEndpointOutput.error) Result.t Async.Deferred.t
