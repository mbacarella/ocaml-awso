    ...
    ?cfg:Awso.Cfg.t ->
      CreateCustomDomainAssociationMessage.t ->
        (CreateCustomDomainAssociationResult.t,
          CreateCustomDomainAssociationResult.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateRedshiftIdcApplicationMessage.t ->
        (CreateRedshiftIdcApplicationResult.t,
          CreateRedshiftIdcApplicationResult.error) Result.t Lwt.t
...
val delete_custom_domain_association :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteCustomDomainAssociationMessage.t -> (unit, unit) Result.t Lwt.t
...
val delete_redshift_idc_application :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteRedshiftIdcApplicationMessage.t -> (unit, unit) Result.t Lwt.t
val delete_resource_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteResourcePolicyMessage.t -> (unit, unit) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeregisterNamespaceInputMessage.t ->
        (DeregisterNamespaceOutputMessage.t,
          DeregisterNamespaceOutputMessage.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeCustomDomainAssociationsMessage.t ->
        (CustomDomainAssociationsMessage.t,
          CustomDomainAssociationsMessage.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeIntegrationsMessage.t ->
        (IntegrationsMessage.t, IntegrationsMessage.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeRedshiftIdcApplicationsMessage.t ->
        (DescribeRedshiftIdcApplicationsResult.t,
          DescribeRedshiftIdcApplicationsResult.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyCustomDomainAssociationMessage.t ->
        (ModifyCustomDomainAssociationResult.t,
          ModifyCustomDomainAssociationResult.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyRedshiftIdcApplicationMessage.t ->
        (ModifyRedshiftIdcApplicationResult.t,
          ModifyRedshiftIdcApplicationResult.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      RegisterNamespaceInputMessage.t ->
        (RegisterNamespaceOutputMessage.t,
          RegisterNamespaceOutputMessage.error) Result.t Lwt.t
