  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AssociateDataShareConsumerMessage.t ->
        (DataShare.t, DataShare.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      AuthorizeSnapshotAccessMessage.t ->
        (AuthorizeSnapshotAccessResult.t,
          AuthorizeSnapshotAccessResult.error) Result.t Async.Deferred.t
val batch_delete_cluster_snapshots :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      BatchDeleteClusterSnapshotsRequest.t ->
        (BatchDeleteClusterSnapshotsResult.t,
          BatchDeleteClusterSnapshotsResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateAuthenticationProfileMessage.t ->
        (CreateAuthenticationProfileResult.t,
          CreateAuthenticationProfileResult.error) Result.t Async.Deferred.t
val create_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      CreateClusterParameterGroupMessage.t ->
        (CreateClusterParameterGroupResult.t,
          CreateClusterParameterGroupResult.error) Result.t Async.Deferred.t
val create_cluster_security_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateClusterSecurityGroupMessage.t ->
        (CreateClusterSecurityGroupResult.t,
          CreateClusterSecurityGroupResult.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateEndpointAccessMessage.t ->
        (EndpointAccess.t, EndpointAccess.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateHsmClientCertificateMessage.t ->
        (CreateHsmClientCertificateResult.t,
          CreateHsmClientCertificateResult.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateScheduledActionMessage.t ->
        (ScheduledAction.t, ScheduledAction.error) Result.t Async.Deferred.t
val create_snapshot_copy_grant :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateSnapshotCopyGrantMessage.t ->
        (CreateSnapshotCopyGrantResult.t,
          CreateSnapshotCopyGrantResult.error) Result.t Async.Deferred.t
...
val create_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateTagsMessage.t -> (unit, unit) Result.t Async.Deferred.t
val create_usage_limit :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateUsageLimitMessage.t ->
        (UsageLimit.t, UsageLimit.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteAuthenticationProfileMessage.t ->
        (DeleteAuthenticationProfileResult.t,
          DeleteAuthenticationProfileResult.error) Result.t Async.Deferred.t
val delete_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val delete_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteTagsMessage.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeClusterParameterGroupsMessage.t ->
        (ClusterParameterGroupsMessage.t,
          ClusterParameterGroupsMessage.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeClusterSnapshotsMessage.t ->
        (SnapshotMessage.t, SnapshotMessage.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeUsageLimitsMessage.t ->
        (UsageLimitList.t, UsageLimitList.error) Result.t Async.Deferred.t
val disable_logging :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyAuthenticationProfileMessage.t ->
        (ModifyAuthenticationProfileResult.t,
          ModifyAuthenticationProfileResult.error) Result.t Async.Deferred.t
val modify_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyClusterDbRevisionMessage.t ->
        (ModifyClusterDbRevisionResult.t,
          ModifyClusterDbRevisionResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyClusterMaintenanceMessage.t ->
        (ModifyClusterMaintenanceResult.t,
          ModifyClusterMaintenanceResult.error) Result.t Async.Deferred.t
val modify_cluster_parameter_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ModifyClusterParameterGroupMessage.t ->
        (ClusterParameterGroupNameMessage.t,
          ClusterParameterGroupNameMessage.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      RestoreFromClusterSnapshotMessage.t ->
        (RestoreFromClusterSnapshotResult.t,
          RestoreFromClusterSnapshotResult.error) Result.t Async.Deferred.t
