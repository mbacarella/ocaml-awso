...
module ContentSummary =
  struct
    type nonrec t =
      ...
      status: ContentStatus.t ;
      tags: Tags.t option ;
      title: ContentTitle.t }
...
module AssistantSummary =
  struct
    type nonrec t =
      ...
      serverSideEncryptionConfiguration:
        ServerSideEncryptionConfiguration.t option ;
      status: AssistantStatus.t ;
      tags: Tags.t option ;
      type_: AssistantType.t }
