...
val delete_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAlarmMuteRuleInput.t -> (unit, unit) Result.t Lwt.t
val delete_alarms :
  ?endpoint_url:string ->
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeAlarmContributorsInput.t ->
        (DescribeAlarmContributorsOutput.t,
          DescribeAlarmContributorsOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListManagedInsightRulesInput.t ->
        (ListManagedInsightRulesOutput.t,
          ListManagedInsightRulesOutput.error) Result.t Lwt.t
...
val put_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutAlarmMuteRuleInput.t -> (unit, unit) Result.t Lwt.t
