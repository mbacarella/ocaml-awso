...
val delete_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteAlarmMuteRuleInput.t -> (unit, unit) Result.t
val delete_alarms :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteAlarmsInput.t -> (unit, unit) Result.t
...
val disable_alarm_actions :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DisableAlarmActionsInput.t -> (unit, unit) Result.t
...
val enable_alarm_actions :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> EnableAlarmActionsInput.t -> (unit, unit) Result.t
...
val put_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutAlarmMuteRuleInput.t -> (unit, unit) Result.t
...
val put_composite_alarm :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutCompositeAlarmInput.t -> (unit, unit) Result.t
val put_dashboard :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutDashboardInput.t ->
...
val put_metric_alarm :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutMetricAlarmInput.t -> (unit, unit) Result.t
val put_metric_data :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutMetricDataInput.t -> (unit, unit) Result.t
...
val set_alarm_state :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> SetAlarmStateInput.t -> (unit, unit) Result.t
