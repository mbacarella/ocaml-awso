...
val delete_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAlarmMuteRuleInput.t -> (unit, unit) Result.t Async.Deferred.t
val delete_alarms :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAlarmsInput.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteMetricStreamInput.t ->
        (DeleteMetricStreamOutput.t, DeleteMetricStreamOutput.error) Result.t
          Async.Deferred.t
val describe_alarm_contributors :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeAlarmContributorsInput.t ->
        (DescribeAlarmContributorsOutput.t,
          DescribeAlarmContributorsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeAlarmsForMetricInput.t ->
        (DescribeAlarmsForMetricOutput.t,
          DescribeAlarmsForMetricOutput.error) Result.t Async.Deferred.t
val describe_anomaly_detectors :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeAnomalyDetectorsInput.t ->
        (DescribeAnomalyDetectorsOutput.t,
          DescribeAnomalyDetectorsOutput.error) Result.t Async.Deferred.t
...
val disable_alarm_actions :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DisableAlarmActionsInput.t -> (unit, unit) Result.t Async.Deferred.t
...
val enable_alarm_actions :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      EnableAlarmActionsInput.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      EnableInsightRulesInput.t ->
        (EnableInsightRulesOutput.t, EnableInsightRulesOutput.error) Result.t
          Async.Deferred.t
val get_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetAlarmMuteRuleInput.t ->
        (GetAlarmMuteRuleOutput.t, GetAlarmMuteRuleOutput.error) Result.t
          Async.Deferred.t
val get_dashboard :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetMetricWidgetImageInput.t ->
        (GetMetricWidgetImageOutput.t, GetMetricWidgetImageOutput.error)
          Result.t Async.Deferred.t
val get_o_tel_enrichment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetOTelEnrichmentInput.t ->
        (GetOTelEnrichmentOutput.t, GetOTelEnrichmentOutput.error) Result.t
          Async.Deferred.t
val list_alarm_mute_rules :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListAlarmMuteRulesInput.t ->
        (ListAlarmMuteRulesOutput.t, ListAlarmMuteRulesOutput.error) Result.t
          Async.Deferred.t
val list_dashboards :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListDashboardsInput.t ->
        (ListDashboardsOutput.t, ListDashboardsOutput.error) Result.t
          Async.Deferred.t
val list_managed_insight_rules :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListManagedInsightRulesInput.t ->
        (ListManagedInsightRulesOutput.t,
          ListManagedInsightRulesOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListTagsForResourceInput.t ->
        (ListTagsForResourceOutput.t, ListTagsForResourceOutput.error)
          Result.t Async.Deferred.t
val put_alarm_mute_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutAlarmMuteRuleInput.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_composite_alarm :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutCompositeAlarmInput.t -> (unit, unit) Result.t Async.Deferred.t
val put_dashboard :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutDashboardInput.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      PutInsightRuleInput.t ->
        (PutInsightRuleOutput.t, PutInsightRuleOutput.error) Result.t
          Async.Deferred.t
val put_managed_insight_rules :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutManagedInsightRulesInput.t ->
        (PutManagedInsightRulesOutput.t, PutManagedInsightRulesOutput.error)
          Result.t Async.Deferred.t
val put_metric_alarm :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutMetricAlarmInput.t -> (unit, unit) Result.t Async.Deferred.t
val put_metric_data :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutMetricDataInput.t -> (unit, unit) Result.t Async.Deferred.t
...
val set_alarm_state :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SetAlarmStateInput.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartMetricStreamsInput.t ->
        (StartMetricStreamsOutput.t, StartMetricStreamsOutput.error) Result.t
          Async.Deferred.t
val start_o_tel_enrichment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartOTelEnrichmentInput.t ->
        (StartOTelEnrichmentOutput.t, StartOTelEnrichmentOutput.error)
          Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StopMetricStreamsInput.t ->
        (StopMetricStreamsOutput.t, StopMetricStreamsOutput.error) Result.t
          Async.Deferred.t
val stop_o_tel_enrichment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopOTelEnrichmentInput.t ->
        (StopOTelEnrichmentOutput.t, StopOTelEnrichmentOutput.error) Result.t
          Async.Deferred.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
