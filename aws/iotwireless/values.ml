...
module LoRaWANGateway =
  struct
    type nonrec t =
      {
      gatewayEui: GatewayEui.t option ;
...
module SessionKeysAbpV1_0_x =
  struct
    type nonrec t = {
      nwkSKey: NwkSKey.t option ;
      appSKey: AppSKey.t option }
...
module SessionKeysAbpV1_1 =
  struct
    type nonrec t =
      {
      fNwkSIntKey: FNwkSIntKey.t option ;
      sNwkSIntKey: SNwkSIntKey.t option ;
      nwkSEncKey: NwkSEncKey.t option ;
      appSKey: AppSKey.t option }
...
module WirelessDeviceStatistics =
  struct
    type nonrec t =
      ...
      lastUplinkReceivedAt: ISODateTimeString.t option ;
      loRaWAN: LoRaWANListDevice.t option ;
...
module OtaaV1_0_x =
  struct
    type nonrec t =
      {
      appKey: AppKey.t option ;
      appEui: AppEui.t option ;
      genAppKey: GenAppKey.t option }
    let make ?appKey =
      fun ?appEui ->
...
module LoRaWANDeviceMetadata =
  struct
    type nonrec t =
      {
      devEui: DevEui.t option ;
      fPort: Integer.t option ;
      dataRate: Integer.t option ;
...
module LoRaWANGetServiceProfileInfo =
  struct
    type nonrec t =
      ...
      drMin: DrMin.t option ;
      drMax: DrMax.t option ;
      channelMask: ChannelMask.t option ;
      prAllowed: PrAllowed.t option ;
      hrAllowed: HrAllowed.t option ;
      raAllowed: RaAllowed.t option ;
      nwkGeoLoc: NwkGeoLoc.t option ;
      targetPer: TargetPer.t option ;
...
module LoRaWANDeviceProfile =
  struct
    type nonrec t =
      ...
      pingSlotDr: PingSlotDr.t option ;
      ...
      rxDelay1: RxDelay1.t option ;
      rxDrOffset1: RxDrOffset1.t option ;
      rxDataRate2: RxDataRate2.t option ;
      rxFreq2: RxFreq2.t option ;
      factoryPresetFreqsList: FactoryPresetFreqsList.t option ;
      maxEirp: MaxEirp.t option ;
