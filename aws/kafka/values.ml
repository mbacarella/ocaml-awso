...
module NodeInfo =
  struct
    type nonrec t =
      {
      addedToClusterTime: Zz__string.t option ;
      brokerNodeInfo: BrokerNodeInfo.t option ;
      instanceType: Zz__string.t option ;
...
module UpdateClusterKafkaVersionRequest =
  struct
    type nonrec t =
      ...
      configurationInfo: ConfigurationInfo.t option ;
      currentVersion: Zz__string.t ;
      targetKafkaVersion: Zz__string.t }
