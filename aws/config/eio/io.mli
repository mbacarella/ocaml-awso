    ...
    ?cfg:Awso_eio.Cfg.t ->
      AssociateResourceTypesRequest.t ->
        (AssociateResourceTypesResponse.t,
          AssociateResourceTypesResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      BatchGetResourceConfigRequest.t ->
        (BatchGetResourceConfigResponse.t,
          BatchGetResourceConfigResponse.error) Result.t
val delete_aggregation_authorization :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteAggregationAuthorizationRequest.t -> (unit, unit) Result.t
val delete_config_rule :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteConfigRuleRequest.t -> (unit, unit) Result.t
val delete_configuration_aggregator :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteConfigurationAggregatorRequest.t -> (unit, unit) Result.t
val delete_configuration_recorder :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteConfigurationRecorderRequest.t -> (unit, unit) Result.t
val delete_conformance_pack :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteConformancePackRequest.t -> (unit, unit) Result.t
val delete_delivery_channel :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteDeliveryChannelRequest.t -> (unit, unit) Result.t
val delete_evaluation_results :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteEvaluationResultsRequest.t ->
        (DeleteEvaluationResultsResponse.t,
          DeleteEvaluationResultsResponse.error) Result.t
val delete_organization_config_rule :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteOrganizationConfigRuleRequest.t -> (unit, unit) Result.t
val delete_organization_conformance_pack :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteOrganizationConformancePackRequest.t -> (unit, unit) Result.t
val delete_pending_aggregation_request :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeletePendingAggregationRequestRequest.t -> (unit, unit) Result.t
...
val delete_resource_config :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteResourceConfigRequest.t -> (unit, unit) Result.t
val delete_retention_configuration :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteRetentionConfigurationRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DeliverConfigSnapshotRequest.t ->
        (DeliverConfigSnapshotResponse.t,
          DeliverConfigSnapshotResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DescribeConformancePacksRequest.t ->
        (DescribeConformancePacksResponse.t,
          DescribeConformancePacksResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DescribeDeliveryChannelsRequest.t ->
        (DescribeDeliveryChannelsResponse.t,
          DescribeDeliveryChannelsResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DisassociateResourceTypesRequest.t ->
        (DisassociateResourceTypesResponse.t,
          DisassociateResourceTypesResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      GetAggregateResourceConfigRequest.t ->
        (GetAggregateResourceConfigResponse.t,
          GetAggregateResourceConfigResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListConfigurationRecordersRequest.t ->
        (ListConfigurationRecordersResponse.t,
          ListConfigurationRecordersResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListConformancePackComplianceScoresRequest.t ->
        (ListConformancePackComplianceScoresResponse.t,
          ListConformancePackComplianceScoresResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListResourceEvaluationsRequest.t ->
        (ListResourceEvaluationsResponse.t,
          ListResourceEvaluationsResponse.error) Result.t
...
val put_config_rule :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutConfigRuleRequest.t -> (unit, unit) Result.t
val put_configuration_aggregator :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutConfigurationAggregatorRequest.t ->
        (PutConfigurationAggregatorResponse.t,
          PutConfigurationAggregatorResponse.error) Result.t
val put_configuration_recorder :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutConfigurationRecorderRequest.t -> (unit, unit) Result.t
...
val put_delivery_channel :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutDeliveryChannelRequest.t -> (unit, unit) Result.t
val put_evaluations :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
    ...
    ?cfg:Awso_eio.Cfg.t ->
      PutRemediationExceptionsRequest.t ->
        (PutRemediationExceptionsResponse.t,
          PutRemediationExceptionsResponse.error) Result.t
val put_resource_config :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutResourceConfigRequest.t -> (unit, unit) Result.t
val put_retention_configuration :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutRetentionConfigurationRequest.t ->
        (PutRetentionConfigurationResponse.t,
          PutRetentionConfigurationResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      PutServiceLinkedConfigurationRecorderRequest.t ->
        (PutServiceLinkedConfigurationRecorderResponse.t,
          PutServiceLinkedConfigurationRecorderResponse.error) Result.t
