...
val delete_config_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteConfigRuleRequest.t -> (unit, unit) Result.t
...
val delete_resource_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteResourceConfigRequest.t -> (unit, unit) Result.t
...
val put_config_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutConfigRuleRequest.t -> (unit, unit) Result.t
...
val put_delivery_channel :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutDeliveryChannelRequest.t -> (unit, unit) Result.t
val put_evaluations :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val put_resource_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutResourceConfigRequest.t -> (unit, unit) Result.t
