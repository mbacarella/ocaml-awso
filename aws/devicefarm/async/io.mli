    ...
    ?cfg:Awso.Cfg.t ->
      CreateRemoteAccessSessionRequest.t ->
        (CreateRemoteAccessSessionResult.t,
          CreateRemoteAccessSessionResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateVPCEConfigurationRequest.t ->
        (CreateVPCEConfigurationResult.t,
          CreateVPCEConfigurationResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteRemoteAccessSessionRequest.t ->
        (DeleteRemoteAccessSessionResult.t,
          DeleteRemoteAccessSessionResult.error) Result.t Async.Deferred.t
val delete_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteRunRequest.t ->
        (DeleteRunResult.t, DeleteRunResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteVPCEConfigurationRequest.t ->
        (DeleteVPCEConfigurationResult.t,
          DeleteVPCEConfigurationResult.error) Result.t Async.Deferred.t
...
val get_device :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetDeviceRequest.t ->
        (GetDeviceResult.t, GetDeviceResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetDevicePoolCompatibilityRequest.t ->
        (GetDevicePoolCompatibilityResult.t,
          GetDevicePoolCompatibilityResult.error) Result.t Async.Deferred.t
...
val get_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetRunRequest.t ->
        (GetRunResult.t, GetRunResult.error) Result.t Async.Deferred.t
val get_suite :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetSuiteRequest.t ->
        (GetSuiteResult.t, GetSuiteResult.error) Result.t Async.Deferred.t
val get_test :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetTestRequest.t ->
        (GetTestResult.t, GetTestResult.error) Result.t Async.Deferred.t
...
val get_upload :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetUploadRequest.t ->
        (GetUploadResult.t, GetUploadResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      InstallToRemoteAccessSessionRequest.t ->
        (InstallToRemoteAccessSessionResult.t,
          InstallToRemoteAccessSessionResult.error) Result.t Async.Deferred.t
val list_artifacts :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListOfferingTransactionsRequest.t ->
        (ListOfferingTransactionsResult.t,
          ListOfferingTransactionsResult.error) Result.t Async.Deferred.t
val list_offerings :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListRemoteAccessSessionsRequest.t ->
        (ListRemoteAccessSessionsResult.t,
          ListRemoteAccessSessionsResult.error) Result.t Async.Deferred.t
val list_runs :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListRunsRequest.t ->
        (ListRunsResult.t, ListRunsResult.error) Result.t Async.Deferred.t
val list_samples :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListTestGridSessionActionsRequest.t ->
        (ListTestGridSessionActionsResult.t,
          ListTestGridSessionActionsResult.error) Result.t Async.Deferred.t
val list_test_grid_session_artifacts :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListTestGridSessionArtifactsRequest.t ->
        (ListTestGridSessionArtifactsResult.t,
          ListTestGridSessionArtifactsResult.error) Result.t Async.Deferred.t
...
val list_tests :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListTestsRequest.t ->
        (ListTestsResult.t, ListTestsResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StopRemoteAccessSessionRequest.t ->
        (StopRemoteAccessSessionResult.t,
          StopRemoteAccessSessionResult.error) Result.t Async.Deferred.t
val stop_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopRunRequest.t ->
        (StopRunResult.t, StopRunResult.error) Result.t Async.Deferred.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateVPCEConfigurationRequest.t ->
        (UpdateVPCEConfigurationResult.t,
          UpdateVPCEConfigurationResult.error) Result.t Async.Deferred.t