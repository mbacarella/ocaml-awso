...
module User =
  struct
    type nonrec t =
      ...
      status: UserStatusType.t option ;
...
module CommentMetadata =
  struct
    type nonrec t =
      {
      commentId: CommentIdType.t option ;
...
module Participants =
  struct
    type nonrec t =
      {
      users: UserMetadataList.t option ;
...
module ResourceMetadata =
  struct
    type nonrec t =
      ...
      id: ResourceIdType.t option ;
      versionId: DocumentVersionIdType.t option ;
      owner: UserMetadata.t option ;
...
module ShareResult =
  struct
    type nonrec t =
      ...
      role: RoleType.t option ;
      status: ShareStatusType.t option ;
      shareId: ResourceIdType.t option ;
      statusMessage: MessageType.t option }
...
module DescribeUsersResponse =
  struct
    type nonrec t =
      {
      users: OrganizationUserList.t option ;
...
module DescribeFolderContentsRequest =
  struct
    type nonrec t =
      ...
      authenticationToken: AuthenticationHeaderType.t option ;
      folderId: ResourceIdType.t ;
      sort: ResourceSortType.t option ;
      order: OrderType.t option ;
      limit: LimitType.t option ;
      marker: PageMarkerType.t option ;
      type_: FolderContentType.t option ;
