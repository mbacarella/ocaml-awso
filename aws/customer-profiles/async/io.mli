    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDomainObjectTypeRequest.t ->
        (DeleteDomainObjectTypeResponse.t,
          DeleteDomainObjectTypeResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteRecommenderFilterRequest.t ->
        (DeleteRecommenderFilterResponse.t,
          DeleteRecommenderFilterResponse.error) Result.t Async.Deferred.t
val delete_recommender_schema :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteRecommenderSchemaRequest.t ->
        (DeleteRecommenderSchemaResponse.t,
          DeleteRecommenderSchemaResponse.error) Result.t Async.Deferred.t
val delete_segment_definition :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteSegmentDefinitionRequest.t ->
        (DeleteSegmentDefinitionResponse.t,
          DeleteSegmentDefinitionResponse.error) Result.t Async.Deferred.t
val delete_workflow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DetectProfileObjectTypeRequest.t ->
        (DetectProfileObjectTypeResponse.t,
          DetectProfileObjectTypeResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetProfileHistoryRecordRequest.t ->
        (GetProfileHistoryRecordResponse.t,
          GetProfileHistoryRecordResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetProfileRecommendationsRequest.t ->
        (GetProfileRecommendationsResponse.t,
          GetProfileRecommendationsResponse.error) Result.t Async.Deferred.t
val get_recommender :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListDomainObjectTypesRequest.t ->
        (ListDomainObjectTypesResponse.t,
          ListDomainObjectTypesResponse.error) Result.t Async.Deferred.t
val list_domains :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListRecommenderFiltersRequest.t ->
        (ListRecommenderFiltersResponse.t,
          ListRecommenderFiltersResponse.error) Result.t Async.Deferred.t
val list_recommender_recipes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListRecommenderRecipesRequest.t ->
        (ListRecommenderRecipesResponse.t,
          ListRecommenderRecipesResponse.error) Result.t Async.Deferred.t
val list_recommender_schemas :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListRecommenderSchemasRequest.t ->
        (ListRecommenderSchemasResponse.t,
          ListRecommenderSchemasResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListSegmentDefinitionsRequest.t ->
        (ListSegmentDefinitionsResponse.t,
          ListSegmentDefinitionsResponse.error) Result.t Async.Deferred.t
