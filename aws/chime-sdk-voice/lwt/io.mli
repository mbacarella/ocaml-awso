    ...
    ?cfg:Awso.Cfg.t ->
      CreateVoiceProfileDomainRequest.t ->
        (CreateVoiceProfileDomainResponse.t,
          CreateVoiceProfileDomainResponse.error) Result.t Lwt.t
...
val delete_voice_profile :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteVoiceProfileRequest.t -> (unit, unit) Result.t Lwt.t
val delete_voice_profile_domain :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteVoiceProfileDomainRequest.t -> (unit, unit) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetVoiceProfileDomainRequest.t ->
        (GetVoiceProfileDomainResponse.t,
          GetVoiceProfileDomainResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      unit ->
        (ListAvailableVoiceConnectorRegionsResponse.t,
          ListAvailableVoiceConnectorRegionsResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListVoiceProfileDomainsRequest.t ->
        (ListVoiceProfileDomainsResponse.t,
          ListVoiceProfileDomainsResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateVoiceProfileDomainRequest.t ->
        (UpdateVoiceProfileDomainResponse.t,
          UpdateVoiceProfileDomainResponse.error) Result.t Lwt.t
