...
val delete_proxy_session :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteProxySessionRequest.t -> (unit, unit) Result.t
...
val delete_sip_rule :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteSipRuleRequest.t -> (unit, unit) Result.t
val delete_voice_connector :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteVoiceConnectorRequest.t -> (unit, unit) Result.t
...
val delete_voice_profile :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteVoiceProfileRequest.t -> (unit, unit) Result.t
