    ...
    ?cfg:Awso.Cfg.t ->
      CreateVoiceProfileDomainRequest.t ->
        (CreateVoiceProfileDomainResponse.t,
          CreateVoiceProfileDomainResponse.error) Result.t Async.Deferred.t
...
val delete_voice_profile :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteVoiceProfileRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_voice_profile_domain :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteVoiceProfileDomainRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetVoiceProfileDomainRequest.t ->
        (GetVoiceProfileDomainResponse.t,
          GetVoiceProfileDomainResponse.error) Result.t Async.Deferred.t
val get_voice_tone_analysis_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetVoiceToneAnalysisTaskRequest.t ->
        (GetVoiceToneAnalysisTaskResponse.t,
          GetVoiceToneAnalysisTaskResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListVoiceProfileDomainsRequest.t ->
        (ListVoiceProfileDomainsResponse.t,
          ListVoiceProfileDomainsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartSpeakerSearchTaskRequest.t ->
        (StartSpeakerSearchTaskResponse.t,
          StartSpeakerSearchTaskResponse.error) Result.t Async.Deferred.t
val start_voice_tone_analysis_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartVoiceToneAnalysisTaskRequest.t ->
        (StartVoiceToneAnalysisTaskResponse.t,
          StartVoiceToneAnalysisTaskResponse.error) Result.t Async.Deferred.t
val stop_speaker_search_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopSpeakerSearchTaskRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val stop_voice_tone_analysis_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopVoiceToneAnalysisTaskRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateVoiceProfileDomainRequest.t ->
        (UpdateVoiceProfileDomainResponse.t,
          UpdateVoiceProfileDomainResponse.error) Result.t Async.Deferred.t
