    ...
    ?cfg:Awso.Cfg.t ->
      AssociateTrackerConsumerRequest.t ->
        (AssociateTrackerConsumerResponse.t,
          AssociateTrackerConsumerResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      BatchUpdateDevicePositionRequest.t ->
        (BatchUpdateDevicePositionResponse.t,
          BatchUpdateDevicePositionResponse.error) Result.t
val calculate_route :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      CreateRouteCalculatorRequest.t ->
        (CreateRouteCalculatorResponse.t,
          CreateRouteCalculatorResponse.error) Result.t
val create_tracker :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteRouteCalculatorRequest.t ->
        (DeleteRouteCalculatorResponse.t,
          DeleteRouteCalculatorResponse.error) Result.t
val delete_tracker :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeRouteCalculatorRequest.t ->
        (DescribeRouteCalculatorResponse.t,
          DescribeRouteCalculatorResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetDevicePositionHistoryRequest.t ->
        (GetDevicePositionHistoryResponse.t,
          GetDevicePositionHistoryResponse.error) Result.t
val get_geofence :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetMapStyleDescriptorRequest.t ->
        (GetMapStyleDescriptorResponse.t,
          GetMapStyleDescriptorResponse.error) Result.t
val get_map_tile :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetMapTileRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListGeofenceCollectionsRequest.t ->
        (ListGeofenceCollectionsResponse.t,
          ListGeofenceCollectionsResponse.error) Result.t
val list_geofences :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateRouteCalculatorRequest.t ->
        (UpdateRouteCalculatorResponse.t,
          UpdateRouteCalculatorResponse.error) Result.t
val update_tracker :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
