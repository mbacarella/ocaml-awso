...
val create_mesh :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateMeshInput.t ->
        (CreateMeshOutput.t, CreateMeshOutput.error) Result.t Lwt.t
val create_route :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateRouteInput.t ->
        (CreateRouteOutput.t, CreateRouteOutput.error) Result.t Lwt.t
...
val delete_mesh :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteMeshInput.t ->
        (DeleteMeshOutput.t, DeleteMeshOutput.error) Result.t Lwt.t
val delete_route :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteRouteInput.t ->
        (DeleteRouteOutput.t, DeleteRouteOutput.error) Result.t Lwt.t
...
val describe_mesh :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeMeshInput.t ->
        (DescribeMeshOutput.t, DescribeMeshOutput.error) Result.t Lwt.t
val describe_route :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeRouteInput.t ->
        (DescribeRouteOutput.t, DescribeRouteOutput.error) Result.t Lwt.t
...
val list_meshes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListMeshesInput.t ->
        (ListMeshesOutput.t, ListMeshesOutput.error) Result.t Lwt.t
val list_routes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListRoutesInput.t ->
        (ListRoutesOutput.t, ListRoutesOutput.error) Result.t Lwt.t
...
val update_mesh :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateMeshInput.t ->
        (UpdateMeshOutput.t, UpdateMeshOutput.error) Result.t Lwt.t
val update_route :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateRouteInput.t ->
        (UpdateRouteOutput.t, UpdateRouteOutput.error) Result.t Lwt.t
