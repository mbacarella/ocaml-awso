  ...
  struct
    type nonrec t =
      ...
      certificateAuthorityArns: CertificateAuthorityArns.t
        [@ocaml.doc "One or more ACM Amazon Resource Name (ARN)s."]}
...
module ListenerTlsFileCertificate =
  struct
    type nonrec t =
      {
      certificateChain: FilePath.t
        [@ocaml.doc "The certificate chain for the certificate."];
...
module MatchRange =
  struct
    type nonrec t =
      {
      end_: Long.t [@ocaml.doc "The end of the range."];
      start: Long.t [@ocaml.doc "The start of the range."]}
  ...
  struct
    type nonrec t =
      ...
      ports: PortSet.t option
        [@ocaml.doc "One or more ports that the policy is enforced for."];
...
module Duration =
  struct
    type nonrec t =
      {
      unit: DurationUnit.t option [@ocaml.doc "A unit of time."];
      value: DurationValue.t option [@ocaml.doc "A number of time units."]}
  ...
  struct
    type nonrec t =
      ...
      exact: String_.t option
        [@ocaml.doc "The exact query parameter to match on."]}
    let make ?exact = fun () -> { exact }
    let to_value x =
      structure_to_value
...
module GrpcMetadataMatchMethod =
  struct
    type nonrec t =
      {
      exact: HeaderMatch.t option
        [@ocaml.doc "The exact method header to be matched on."];
      prefix: HeaderMatch.t option
        [@ocaml.doc
          "The specified beginning characters of the method header to be matched on."];
      range: MatchRange.t option ;
      regex: HeaderMatch.t option
        [@ocaml.doc "The regex used to match the method header."];
      suffix: HeaderMatch.t option
        [@ocaml.doc
...
module GrpcRouteMetadata =
  struct
    type nonrec t =
      ...
      name: HeaderName.t [@ocaml.doc "The name of the route."]}
  ...
  struct
    type nonrec t =
      ...
      match_: QueryParameterMatch.t option
        [@ocaml.doc "The query parameter to match on."];
  ...
  struct
    type nonrec t =
      ...
      match_: HeaderMatchMethod.t option
        [@ocaml.doc "The HeaderMatchMethod object."];
      name: HeaderName.t
        [@ocaml.doc
  ...
  struct
    type nonrec t =
      ...
      defaultTargetHostname: DefaultGatewayRouteRewrite.t option
        [@ocaml.doc "The default target host name to write to."]}
  ...
  struct
    type nonrec t =
      ...
      match_: GrpcMetadataMatchMethod.t option
        [@ocaml.doc "The criteria for determining a metadata match."];
      name: HeaderName.t
        [@ocaml.doc "A name for the gateway route metadata."]}
...
module HttpGatewayRoutePathRewrite =
  struct
    type nonrec t =
      {
      exact: HttpPathExact.t option [@ocaml.doc "The exact path to rewrite."]}
    let make ?exact = fun () -> { exact }
    let to_value x =
      structure_to_value
...
module PortMapping =
  struct
    type nonrec t =
      {
      port: PortNumber.t [@ocaml.doc "The port used for the port mapping."];
  ...
  struct
    type nonrec t =
      ...
      mode: ListenerTlsMode.t
        [@ocaml.doc
          "Specify one of the following modes. STRICT \226\128\147 Listener only accepts connections with TLS enabled. PERMISSIVE \226\128\147 Listener accepts connections with or without TLS enabled. DISABLED \226\128\147 Listener only accepts connections without TLS."];
  ...
  struct
    type nonrec t =
      ...
      baseEjectionDuration: Duration.t
        [@ocaml.doc "The base amount of time for which a host is ejected."];
      interval: Duration.t
        [@ocaml.doc "The time interval between ejection sweep analysis."];
  ...
  struct
    type nonrec t =
      ...
      grpc: VirtualNodeGrpcConnectionPool.t option
        [@ocaml.doc "An object that represents a type of connection pool."];
...
module VirtualGatewayPortMapping =
  struct
    type nonrec t =
      ...
      protocol: VirtualGatewayPortProtocol.t
        [@ocaml.doc "The protocol used for the port mapping."]}
  ...
  struct
    type nonrec t =
      ...
      exact: HttpPathExact.t option
        [@ocaml.doc "The exact path to match on."];
      regex: HttpPathRegex.t option
        [@ocaml.doc "The regex used to match the path."]}
  ...
  struct
    type nonrec t =
      ...
      hostname: GatewayRouteHostnameRewrite.t option
        [@ocaml.doc "The host name of the gateway route to rewrite."]}
  ...
  struct
    type nonrec t =
      ...
      exact: ExactHostName.t option
        [@ocaml.doc "The exact host name to match on."];
...
module HttpGatewayRouteRewrite =
  struct
    type nonrec t =
      {
      hostname: GatewayRouteHostnameRewrite.t option
        [@ocaml.doc "The host name to rewrite."];
      path: HttpGatewayRoutePathRewrite.t option
        [@ocaml.doc "The path to rewrite."];
      prefix: HttpGatewayRoutePrefixRewrite.t option
        [@ocaml.doc "The specified beginning characters to rewrite."]}
    let make ?hostname =
  ...
  struct
    type nonrec t =
      ...
      virtualService: VirtualServiceBackend.t option
        [@ocaml.doc "Specifies a virtual service to use as a backend."]}
    let make ?virtualService = fun () -> { virtualService }
    let to_value x =
      structure_to_value
        [("virtualService",
  ...
  struct
    type nonrec t =
      ...
      connectionPool: VirtualNodeConnectionPool.t option
        [@ocaml.doc "The connection pool information for the listener."];
      healthCheck: HealthCheckPolicy.t option
        [@ocaml.doc "The health check information for the listener."];
      outlierDetection: OutlierDetection.t option
        [@ocaml.doc "The outlier detection information for the listener."];
      portMapping: PortMapping.t
        [@ocaml.doc "The port mapping information for the listener."];
    ...
    let of_json json =
      ...
      make ?tls ?timeout ~portMapping ?outlierDetection ?healthCheck
        ?connectionPool ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "An object that represents a listener for a virtual node."]
module AccessLog =
  struct
    type nonrec t =
      {
      file: FileAccessLog.t option
        [@ocaml.doc "The file object to send virtual node access logs to."]}
  ...
  struct
    type nonrec t =
      ...
      grpcRetryEvents: GrpcRetryPolicyEvents.t option
        [@ocaml.doc "Specify at least one of the valid values."];
      httpRetryEvents: HttpRetryPolicyEvents.t option
        [@ocaml.doc
          "Specify at least one of the following values. server-error \226\128\147 HTTP status codes 500, 501, 502, 503, 504, 505, 506, 507, 508, 510, and 511 gateway-error \226\128\147 HTTP status codes 502, 503, and 504 client-error \226\128\147 HTTP status code 409 stream-error \226\128\147 Retry on refused stream"];
      maxRetries: MaxRetries.t
        [@ocaml.doc "The maximum number of retry attempts."];
      perRetryTimeout: Duration.t
        [@ocaml.doc "The timeout for each retry attempt."];
  ...
  struct
    type nonrec t =
      ...
      headers: HttpRouteHeaders.t option
        [@ocaml.doc "The client request headers to match on."];
      ...
      queryParameters: HttpQueryParameters.t option
        [@ocaml.doc "The client request query parameters to match on."];
  ...
  struct
    type nonrec t =
      ...
      rewrite: GrpcGatewayRouteRewrite.t option
        [@ocaml.doc "The gateway route action to rewrite."];
  ...
  struct
    type nonrec t =
      ...
      virtualNode: VirtualNodeServiceProvider.t option
        [@ocaml.doc "The virtual node associated with a virtual service."];
      virtualRouter: VirtualRouterServiceProvider.t option
        [@ocaml.doc "The virtual router associated with a virtual service."]}
  ...
  struct
    type nonrec t =
      ...
      accessLog: AccessLog.t option
        [@ocaml.doc "The access log configuration for a virtual node."]}
  ...
  struct
    type nonrec t =
      ...
      dns: DnsServiceDiscovery.t option
        [@ocaml.doc "Specifies the DNS information for the virtual node."]}
  ...
  struct
    type nonrec t =
      ...
      accessLog: VirtualGatewayAccessLog.t option
        [@ocaml.doc "The access log configuration."]}
    let make ?accessLog = fun () -> { accessLog }
    let to_value x =
      structure_to_value
        [("accessLog",
  ...
  struct
    type nonrec t =
      ...
      retryPolicy: GrpcRetryPolicy.t option
        [@ocaml.doc "An object that represents a retry policy."];
...
module MeshStatus =
  struct
    type nonrec t =
      {
      status: MeshStatusCode.t option [@ocaml.doc "The current mesh status."]}
    let make ?status = fun () -> { status }
    let to_value x =
      structure_to_value
  ...
  struct
    type nonrec t =
      ...
      priority: GatewayRoutePriority.t option
        [@ocaml.doc "The ordering of the gateway routes spec."]}
    let make ?grpcRoute =
      fun ?http2Route ->
        fun ?httpRoute ->
          fun ?priority ->
...
module UpdateVirtualServiceInput =
  struct
    type nonrec t =
      ...
      virtualServiceName: ServiceName.t
        [@ocaml.doc "The name of the virtual service to update."]}
    ...
    type nonrec t =
      ...
      clientToken: String_.t option
        [@ocaml.doc
          "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Up to 36 letters, numbers, hyphens, and underscores are allowed."];
      meshName: ResourceName.t
        [@ocaml.doc "The name of the service mesh to update."];
      spec: MeshSpec.t option
        [@ocaml.doc "The service mesh specification to apply."]}
    ...
    type nonrec t =
      ...
      clientToken: String_.t option
        [@ocaml.doc
          "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Up to 36 letters, numbers, hyphens, and underscores are allowed."];
      gatewayRouteName: ResourceName.t
        [@ocaml.doc "The name of the gateway route to update."];
      meshName: ResourceName.t
        [@ocaml.doc
...
module ListRoutesInput =
  struct
    type nonrec t =
      ...
      virtualRouterName: ResourceName.t
        [@ocaml.doc "The name of the virtual router to list routes in."]}
...
module DescribeGatewayRouteInput =
  struct
    type nonrec t =
      {
      gatewayRouteName: ResourceName.t
        [@ocaml.doc "The name of the gateway route to describe."];
      meshName: ResourceName.t
        [@ocaml.doc
          "The name of the service mesh that the gateway route resides in."];
      meshOwner: AccountId.t option
...
module DeleteRouteInput =
  struct
    type nonrec t =
      ...
      virtualRouterName: ResourceName.t
        [@ocaml.doc "The name of the virtual router to delete the route in."]}
...
module DeleteMeshInput =
  struct
    type nonrec t =
      {
      meshName: ResourceName.t
        [@ocaml.doc "The name of the service mesh to delete."]}
...
module DeleteGatewayRouteInput =
  struct
    type nonrec t =
      {
      gatewayRouteName: ResourceName.t
        [@ocaml.doc "The name of the gateway route to delete."];
      meshName: ResourceName.t
        [@ocaml.doc
...
module CreateVirtualServiceInput =
  struct
    type nonrec t =
      ...
      virtualServiceName: ServiceName.t
        [@ocaml.doc "The name to use for the virtual service."]}
    ...
    type nonrec t =
      ...
      clientToken: String_.t option
        [@ocaml.doc
          "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Up to 36 letters, numbers, hyphens, and underscores are allowed."];
      meshName: ResourceName.t
        [@ocaml.doc "The name to use for the service mesh."];
      spec: MeshSpec.t option
        [@ocaml.doc "The service mesh specification to apply."];
      tags: TagList.t option
        [@ocaml.doc
    ...
    type nonrec t =
      ...
      clientToken: String_.t option
        [@ocaml.doc
          "Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Up to 36 letters, numbers, hyphens, and underscores are allowed."];
      gatewayRouteName: ResourceName.t
        [@ocaml.doc "The name to use for the gateway route."];
      meshName: ResourceName.t
        [@ocaml.doc
