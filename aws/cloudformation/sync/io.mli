...
val cancel_update_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> CancelUpdateStackInput.t -> (unit, unit) Result.t
...
val delete_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteStackInput.t -> (unit, unit) Result.t
...
val execute_stack_refactor :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ExecuteStackRefactorInput.t -> (unit, unit) Result.t
...
val set_stack_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetStackPolicyInput.t -> (unit, unit) Result.t
...
val signal_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SignalResourceInput.t -> (unit, unit) Result.t
