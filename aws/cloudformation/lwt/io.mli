    ...
    ?cfg:Awso.Cfg.t ->
      ActivateOrganizationsAccessInput.t ->
        (ActivateOrganizationsAccessOutput.t,
          ActivateOrganizationsAccessOutput.error) Result.t Lwt.t
val activate_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ActivateTypeInput.t ->
        (ActivateTypeOutput.t, ActivateTypeOutput.error) Result.t Lwt.t
val batch_describe_type_configurations :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      BatchDescribeTypeConfigurationsInput.t ->
        (BatchDescribeTypeConfigurationsOutput.t,
          BatchDescribeTypeConfigurationsOutput.error) Result.t Lwt.t
val cancel_update_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CancelUpdateStackInput.t -> (unit, unit) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateChangeSetInput.t ->
        (CreateChangeSetOutput.t, CreateChangeSetOutput.error) Result.t Lwt.t
val create_generated_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateGeneratedTemplateInput.t ->
        (CreateGeneratedTemplateOutput.t,
          CreateGeneratedTemplateOutput.error) Result.t Lwt.t
val create_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateStackInput.t ->
        (CreateStackOutput.t, CreateStackOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateStackSetInput.t ->
        (CreateStackSetOutput.t, CreateStackSetOutput.error) Result.t Lwt.t
val deactivate_organizations_access :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeactivateOrganizationsAccessInput.t ->
        (DeactivateOrganizationsAccessOutput.t,
          DeactivateOrganizationsAccessOutput.error) Result.t Lwt.t
val deactivate_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeactivateTypeInput.t ->
        (DeactivateTypeOutput.t, DeactivateTypeOutput.error) Result.t Lwt.t
val delete_change_set :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteChangeSetInput.t ->
        (DeleteChangeSetOutput.t, DeleteChangeSetOutput.error) Result.t Lwt.t
val delete_generated_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteGeneratedTemplateInput.t -> (unit, unit) Result.t Lwt.t
val delete_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteStackInput.t -> (unit, unit) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteStackSetInput.t ->
        (DeleteStackSetOutput.t, DeleteStackSetOutput.error) Result.t Lwt.t
val deregister_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeregisterTypeInput.t ->
        (DeregisterTypeOutput.t, DeregisterTypeOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeStackDriftDetectionStatusInput.t ->
        (DescribeStackDriftDetectionStatusOutput.t,
          DescribeStackDriftDetectionStatusOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeStackResourceDriftsInput.t ->
        (DescribeStackResourceDriftsOutput.t,
          DescribeStackResourceDriftsOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeStackSetOperationInput.t ->
        (DescribeStackSetOperationOutput.t,
          DescribeStackSetOperationOutput.error) Result.t Lwt.t
val describe_stacks :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeStacksInput.t ->
        (DescribeStacksOutput.t, DescribeStacksOutput.error) Result.t Lwt.t
val describe_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeTypeInput.t ->
        (DescribeTypeOutput.t, DescribeTypeOutput.error) Result.t Lwt.t
val describe_type_registration :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeTypeRegistrationInput.t ->
        (DescribeTypeRegistrationOutput.t,
          DescribeTypeRegistrationOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DetectStackResourceDriftInput.t ->
        (DetectStackResourceDriftOutput.t,
          DetectStackResourceDriftOutput.error) Result.t Lwt.t
...
val execute_stack_refactor :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ExecuteStackRefactorInput.t -> (unit, unit) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetHookResultInput.t ->
        (GetHookResultOutput.t, GetHookResultOutput.error) Result.t Lwt.t
val get_stack_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetStackPolicyInput.t ->
        (GetStackPolicyOutput.t, GetStackPolicyOutput.error) Result.t Lwt.t
val get_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetTemplateInput.t ->
        (GetTemplateOutput.t, GetTemplateOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListChangeSetsInput.t ->
        (ListChangeSetsOutput.t, ListChangeSetsOutput.error) Result.t Lwt.t
val list_exports :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListExportsInput.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListHookResultsInput.t ->
        (ListHookResultsOutput.t, ListHookResultsOutput.error) Result.t Lwt.t
val list_imports :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListImportsInput.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListResourceScanRelatedResourcesInput.t ->
        (ListResourceScanRelatedResourcesOutput.t,
          ListResourceScanRelatedResourcesOutput.error) Result.t Lwt.t
val list_resource_scan_resources :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListResourceScanResourcesInput.t ->
        (ListResourceScanResourcesOutput.t,
          ListResourceScanResourcesOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListStackInstanceResourceDriftsInput.t ->
        (ListStackInstanceResourceDriftsOutput.t,
          ListStackInstanceResourceDriftsOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListStackRefactorActionsInput.t ->
        (ListStackRefactorActionsOutput.t,
          ListStackRefactorActionsOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListStackSetAutoDeploymentTargetsInput.t ->
        (ListStackSetAutoDeploymentTargetsOutput.t,
          ListStackSetAutoDeploymentTargetsOutput.error) Result.t Lwt.t
val list_stack_set_operation_results :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListStackSetOperationResultsInput.t ->
        (ListStackSetOperationResultsOutput.t,
          ListStackSetOperationResultsOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListStackSetsInput.t ->
        (ListStackSetsOutput.t, ListStackSetsOutput.error) Result.t Lwt.t
val list_stacks :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListStacksInput.t ->
        (ListStacksOutput.t, ListStacksOutput.error) Result.t Lwt.t
...
val list_types :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListTypesInput.t ->
        (ListTypesOutput.t, ListTypesOutput.error) Result.t Lwt.t
val publish_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PublishTypeInput.t ->
        (PublishTypeOutput.t, PublishTypeOutput.error) Result.t Lwt.t
...
val register_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RegisterTypeInput.t ->
        (RegisterTypeOutput.t, RegisterTypeOutput.error) Result.t Lwt.t
val rollback_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RollbackStackInput.t ->
        (RollbackStackOutput.t, RollbackStackOutput.error) Result.t Lwt.t
val set_stack_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetStackPolicyInput.t -> (unit, unit) Result.t Lwt.t
...
val signal_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SignalResourceInput.t -> (unit, unit) Result.t Lwt.t
...
val test_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      TestTypeInput.t ->
        (TestTypeOutput.t, TestTypeOutput.error) Result.t Lwt.t
val update_generated_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateGeneratedTemplateInput.t ->
        (UpdateGeneratedTemplateOutput.t,
          UpdateGeneratedTemplateOutput.error) Result.t Lwt.t
val update_stack :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateStackInput.t ->
        (UpdateStackOutput.t, UpdateStackOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateStackSetInput.t ->
        (UpdateStackSetOutput.t, UpdateStackSetOutput.error) Result.t Lwt.t
val update_termination_protection :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateTerminationProtectionInput.t ->
        (UpdateTerminationProtectionOutput.t,
          UpdateTerminationProtectionOutput.error) Result.t Lwt.t
