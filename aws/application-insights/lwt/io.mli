  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AddWorkloadRequest.t ->
        (AddWorkloadResponse.t, AddWorkloadResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListWorkloadsRequest.t ->
        (ListWorkloadsResponse.t, ListWorkloadsResponse.error) Result.t Lwt.t
val remove_workload :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateProblemRequest.t ->
        (UpdateProblemResponse.t, UpdateProblemResponse.error) Result.t Lwt.t
val update_workload :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
