...
val delete_form :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteFormRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_theme :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteThemeRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val get_form :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetFormRequest.t ->
        (GetFormResponse.t, GetFormResponse.error) Result.t Async.Deferred.t
val get_metadata :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val put_metadata_flag :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutMetadataFlagRequest.t -> (unit, unit) Result.t Async.Deferred.t
val refresh_token :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
