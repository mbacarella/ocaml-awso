...
val delete_form :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteFormRequest.t -> (unit, unit) Result.t
val delete_theme :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteThemeRequest.t -> (unit, unit) Result.t
...
val put_metadata_flag :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutMetadataFlagRequest.t -> (unit, unit) Result.t
val refresh_token :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
