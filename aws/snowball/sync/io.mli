...
val cancel_job :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CancelJobRequest.t ->
        (CancelJobResult.t, CancelJobResult.error) Result.t
val create_address :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      CreateReturnShippingLabelRequest.t ->
        (CreateReturnShippingLabelResult.t,
          CreateReturnShippingLabelResult.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeReturnShippingLabelRequest.t ->
        (DescribeReturnShippingLabelResult.t,
          DescribeReturnShippingLabelResult.error) Result.t
...
val update_job :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateJobRequest.t ->
        (UpdateJobResult.t, UpdateJobResult.error) Result.t
