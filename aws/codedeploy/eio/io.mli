...
val continue_deployment :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> ContinueDeploymentInput.t -> (unit, unit) Result.t
...
val delete_deployment_config :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteDeploymentConfigInput.t -> (unit, unit) Result.t
...
val update_application :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> UpdateApplicationInput.t -> (unit, unit) Result.t
