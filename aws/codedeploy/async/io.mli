    ...
    ?cfg:Awso.Cfg.t ->
      BatchGetApplicationRevisionsInput.t ->
        (BatchGetApplicationRevisionsOutput.t,
          BatchGetApplicationRevisionsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      BatchGetOnPremisesInstancesInput.t ->
        (BatchGetOnPremisesInstancesOutput.t,
          BatchGetOnPremisesInstancesOutput.error) Result.t Async.Deferred.t
val continue_deployment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ContinueDeploymentInput.t -> (unit, unit) Result.t Async.Deferred.t
...
val delete_deployment_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeploymentConfigInput.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteGitHubAccountTokenInput.t ->
        (DeleteGitHubAccountTokenOutput.t,
          DeleteGitHubAccountTokenOutput.error) Result.t Async.Deferred.t
val delete_resources_by_external_id :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteResourcesByExternalIdInput.t ->
        (DeleteResourcesByExternalIdOutput.t,
          DeleteResourcesByExternalIdOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListApplicationRevisionsInput.t ->
        (ListApplicationRevisionsOutput.t,
          ListApplicationRevisionsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListDeploymentInstancesInput.t ->
        (ListDeploymentInstancesOutput.t,
          ListDeploymentInstancesOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListGitHubAccountTokenNamesInput.t ->
        (ListGitHubAccountTokenNamesOutput.t,
          ListGitHubAccountTokenNamesOutput.error) Result.t Async.Deferred.t
val list_on_premises_instances :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListOnPremisesInstancesInput.t ->
        (ListOnPremisesInstancesOutput.t,
          ListOnPremisesInstancesOutput.error) Result.t Async.Deferred.t
...
val update_application :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateApplicationInput.t -> (unit, unit) Result.t Async.Deferred.t
