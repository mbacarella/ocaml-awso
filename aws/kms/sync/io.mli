...
val create_alias :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> CreateAliasRequest.t -> (unit, unit) Result.t
...
val delete_imported_key_material :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteImportedKeyMaterialRequest.t -> (unit, unit) Result.t
...
val disable_key :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DisableKeyRequest.t -> (unit, unit) Result.t
val disable_key_rotation :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DisableKeyRotationRequest.t -> (unit, unit) Result.t
...
val enable_key :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> EnableKeyRequest.t -> (unit, unit) Result.t
val enable_key_rotation :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> EnableKeyRotationRequest.t -> (unit, unit) Result.t
val encrypt :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val put_key_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutKeyPolicyRequest.t -> (unit, unit) Result.t
val re_encrypt :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ReEncryptRequest.t ->
...
val retire_grant :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> RetireGrantRequest.t -> (unit, unit) Result.t
val revoke_grant :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> RevokeGrantRequest.t -> (unit, unit) Result.t
...
val update_alias :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateAliasRequest.t -> (unit, unit) Result.t
...
val update_key_description :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateKeyDescriptionRequest.t -> (unit, unit) Result.t
val update_primary_region :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdatePrimaryRegionRequest.t -> (unit, unit) Result.t
val verify :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
