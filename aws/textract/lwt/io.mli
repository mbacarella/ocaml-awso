...
val analyze_i_d :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AnalyzeIDRequest.t ->
        (AnalyzeIDResponse.t, AnalyzeIDResponse.error) Result.t Lwt.t
val create_adapter :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateAdapterRequest.t ->
        (CreateAdapterResponse.t, CreateAdapterResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAdapterRequest.t ->
        (DeleteAdapterResponse.t, DeleteAdapterResponse.error) Result.t Lwt.t
...
val get_adapter :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetAdapterRequest.t ->
        (GetAdapterResponse.t, GetAdapterResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetDocumentTextDetectionRequest.t ->
        (GetDocumentTextDetectionResponse.t,
          GetDocumentTextDetectionResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLendingAnalysisSummaryRequest.t ->
        (GetLendingAnalysisSummaryResponse.t,
          GetLendingAnalysisSummaryResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListAdaptersRequest.t ->
        (ListAdaptersResponse.t, ListAdaptersResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartDocumentAnalysisRequest.t ->
        (StartDocumentAnalysisResponse.t,
          StartDocumentAnalysisResponse.error) Result.t Lwt.t
val start_document_text_detection :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartDocumentTextDetectionRequest.t ->
        (StartDocumentTextDetectionResponse.t,
          StartDocumentTextDetectionResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateAdapterRequest.t ->
        (UpdateAdapterResponse.t, UpdateAdapterResponse.error) Result.t Lwt.t