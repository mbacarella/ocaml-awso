    ...
    ?cfg:Awso.Cfg.t ->
      GetDocumentTextDetectionRequest.t ->
        (GetDocumentTextDetectionResponse.t,
          GetDocumentTextDetectionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLendingAnalysisSummaryRequest.t ->
        (GetLendingAnalysisSummaryResponse.t,
          GetLendingAnalysisSummaryResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartDocumentAnalysisRequest.t ->
        (StartDocumentAnalysisResponse.t,
          StartDocumentAnalysisResponse.error) Result.t Async.Deferred.t
val start_document_text_detection :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartDocumentTextDetectionRequest.t ->
        (StartDocumentTextDetectionResponse.t,
          StartDocumentTextDetectionResponse.error) Result.t Async.Deferred.t
