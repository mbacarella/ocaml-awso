    ...
    ?cfg:Awso.Cfg.t ->
      DescribeSecurityPolicyRequest.t ->
        (DescribeSecurityPolicyResponse.t,
          DescribeSecurityPolicyResponse.error) Result.t Lwt.t
val describe_server :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListServersRequest.t ->
        (ListServersResponse.t, ListServersResponse.error) Result.t Lwt.t
...
val stop_server :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> StopServerRequest.t -> (unit, unit) Result.t Lwt.t
val tag_resource :
  ?endpoint_url:string ->
