    ...
    ?cfg:Awso.Cfg.t ->
      BatchGetCommandExecutionsInput.t ->
        (BatchGetCommandExecutionsOutput.t,
          BatchGetCommandExecutionsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteSourceCredentialsInput.t ->
        (DeleteSourceCredentialsOutput.t,
          DeleteSourceCredentialsOutput.error) Result.t Async.Deferred.t
val delete_webhook :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ImportSourceCredentialsInput.t ->
        (ImportSourceCredentialsOutput.t,
          ImportSourceCredentialsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListBuildBatchesForProjectInput.t ->
        (ListBuildBatchesForProjectOutput.t,
          ListBuildBatchesForProjectOutput.error) Result.t Async.Deferred.t
val list_builds :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListBuildsInput.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListCuratedEnvironmentImagesInput.t ->
        (ListCuratedEnvironmentImagesOutput.t,
          ListCuratedEnvironmentImagesOutput.error) Result.t Async.Deferred.t
val list_fleets :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListFleetsInput.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListReportsForReportGroupInput.t ->
        (ListReportsForReportGroupOutput.t,
          ListReportsForReportGroupOutput.error) Result.t Async.Deferred.t
val list_sandboxes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListSandboxesForProjectInput.t ->
        (ListSandboxesForProjectOutput.t,
          ListSandboxesForProjectOutput.error) Result.t Async.Deferred.t
...
val stop_build :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopBuildInput.t ->
        (StopBuildOutput.t, StopBuildOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateProjectVisibilityInput.t ->
        (UpdateProjectVisibilityOutput.t,
          UpdateProjectVisibilityOutput.error) Result.t Async.Deferred.t
