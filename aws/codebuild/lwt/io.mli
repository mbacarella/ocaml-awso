    ...
    ?cfg:Awso.Cfg.t ->
      BatchGetCommandExecutionsInput.t ->
        (BatchGetCommandExecutionsOutput.t,
          BatchGetCommandExecutionsOutput.error) Result.t Lwt.t
val batch_get_fleets :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      BatchGetFleetsInput.t ->
        (BatchGetFleetsOutput.t, BatchGetFleetsOutput.error) Result.t Lwt.t
...
val delete_fleet :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteFleetInput.t ->
        (DeleteFleetOutput.t, DeleteFleetOutput.error) Result.t Lwt.t
val delete_project :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListCommandExecutionsForSandboxInput.t ->
        (ListCommandExecutionsForSandboxOutput.t,
          ListCommandExecutionsForSandboxOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListSandboxesInput.t ->
        (ListSandboxesOutput.t, ListSandboxesOutput.error) Result.t Lwt.t
val list_sandboxes_for_project :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListSandboxesForProjectInput.t ->
        (ListSandboxesForProjectOutput.t,
          ListSandboxesForProjectOutput.error) Result.t Lwt.t
...
val start_sandbox :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartSandboxInput.t ->
        (StartSandboxOutput.t, StartSandboxOutput.error) Result.t Lwt.t
...
val stop_sandbox :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopSandboxInput.t ->
        (StopSandboxOutput.t, StopSandboxOutput.error) Result.t Lwt.t
val update_fleet :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateFleetInput.t ->
        (UpdateFleetOutput.t, UpdateFleetOutput.error) Result.t Lwt.t
val update_project :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
