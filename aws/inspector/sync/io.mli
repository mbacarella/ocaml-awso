...
val delete_assessment_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteAssessmentRunRequest.t -> (unit, unit) Result.t
...
val set_tags_for_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetTagsForResourceRequest.t -> (unit, unit) Result.t
...
val stop_assessment_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> StopAssessmentRunRequest.t -> (unit, unit) Result.t
val subscribe_to_event :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SubscribeToEventRequest.t -> (unit, unit) Result.t
val unsubscribe_from_event :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UnsubscribeFromEventRequest.t -> (unit, unit) Result.t
