...
val delete_assessment_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAssessmentRunRequest.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeAssessmentRunsRequest.t ->
        (DescribeAssessmentRunsResponse.t,
          DescribeAssessmentRunsResponse.error) Result.t Async.Deferred.t
val describe_assessment_targets :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeAssessmentTargetsRequest.t ->
        (DescribeAssessmentTargetsResponse.t,
          DescribeAssessmentTargetsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeResourceGroupsRequest.t ->
        (DescribeResourceGroupsResponse.t,
          DescribeResourceGroupsResponse.error) Result.t Async.Deferred.t
val describe_rules_packages :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeRulesPackagesRequest.t ->
        (DescribeRulesPackagesResponse.t,
          DescribeRulesPackagesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListAssessmentRunAgentsRequest.t ->
        (ListAssessmentRunAgentsResponse.t,
          ListAssessmentRunAgentsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListAssessmentTargetsRequest.t ->
        (ListAssessmentTargetsResponse.t,
          ListAssessmentTargetsResponse.error) Result.t Async.Deferred.t
val list_assessment_templates :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListAssessmentTemplatesRequest.t ->
        (ListAssessmentTemplatesResponse.t,
          ListAssessmentTemplatesResponse.error) Result.t Async.Deferred.t
val list_event_subscriptions :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListEventSubscriptionsRequest.t ->
        (ListEventSubscriptionsResponse.t,
          ListEventSubscriptionsResponse.error) Result.t Async.Deferred.t
val list_exclusions :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val set_tags_for_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SetTagsForResourceRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val stop_assessment_run :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopAssessmentRunRequest.t -> (unit, unit) Result.t Async.Deferred.t
val subscribe_to_event :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SubscribeToEventRequest.t -> (unit, unit) Result.t Async.Deferred.t
val unsubscribe_from_event :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UnsubscribeFromEventRequest.t -> (unit, unit) Result.t Async.Deferred.t
