...
module PathComponent =
  struct
    type nonrec t =
      ...
      resource: NetworkResourceSummary.t option ;
...
module Location =
  struct
    type nonrec t =
      ...
      latitude: ConstrainedString.t option ;
      longitude: ConstrainedString.t option }
    let make ?address =
      fun ?latitude ->
...
module Bandwidth =
  struct
    type nonrec t =
      {
      uploadSpeed: Integer.t option ;
      downloadSpeed: Integer.t option }
...
module NetworkTelemetry =
  struct
    type nonrec t =
      ...
      resourceArn: ResourceArn.t option ;
      address: ConstrainedString.t option ;
      health: ConnectionHealth.t option }
    let make ?registeredGatewayArn =
      fun ?coreNetworkId ->
        fun ?awsRegion ->
          fun ?accountId ->
...
module Relationship =
  struct
    type nonrec t =
      ...
      to_: ConstrainedString.t option }
...
module ConflictException =
  struct
    type nonrec t =
      {
      message: ServerSideString.t ;
      resourceId: ServerSideString.t ;
      resourceType: ServerSideString.t }
...
module VpcAttachment =
  struct
    type nonrec t =
      ...
      subnetArns: SubnetArnList.t option ;
...
module ServiceQuotaExceededException =
  struct
    type nonrec t =
      ...
      limitCode: ServerSideString.t ;
      serviceCode: ServerSideString.t }
...
module RouteAnalysis =
  struct
    type nonrec t =
      ...
      returnPath: RouteAnalysisPath.t option }
    let make ?globalNetworkId =
      fun ?ownerAccountId ->
        fun ?routeAnalysisId ->
          fun ?startTimestamp ->
...
module GetNetworkRoutesRequest =
  struct
    type nonrec t =
      ...
      states: RouteStateList.t option ;
      types: RouteTypeList.t option ;
