...
module QuestionId =
  struct
    type nonrec t = string[@@ocaml.doc "The ID of the question."]
  ...
  struct
    type nonrec t =
      ...
      differenceStatus: DifferenceStatus.t option
        [@ocaml.doc "Indicates the type of change to the question."]}
    let make ?questionId =
      fun ?questionTitle ->
...
module ExceptionMessage =
  struct
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "Description of the error."]
module ValidationExceptionFieldName =
  struct
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "The field name for which validation failed."]
module Notes =
  struct
    type nonrec t = string[@@ocaml.doc
...
module AwsAccountId =
  struct
    type nonrec t = string[@@ocaml.doc "An Amazon Web Services account ID."]
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "An Amazon Web Services account ID."]
module Timestamp =
  struct
    type nonrec t = string[@@ocaml.doc "The date and time recorded."]
    let make i = i
    let of_string x = x
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "The date and time recorded."]
module WorkloadArn =
  struct
    type nonrec t = string[@@ocaml.doc "The ARN for the workload."]
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "The ARN for the workload."]
  ...
  struct
    type nonrec t =
      ...
      displayText: DisplayText.t option
        [@ocaml.doc "The display text for the improvement plan."];
  ...
  struct
    type nonrec t =
      ...
      notes: ChoiceNotes.t option
        [@ocaml.doc "The notes associated with a choice."]}
    let make ?choiceId =
      fun ?status ->
        fun ?reason ->
...
module LensDescription =
  struct
    type nonrec t = string[@@ocaml.doc "The description of the lens."]
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "The description of the lens."]
module LensStatus =
  struct
    type nonrec t =
      | CURRENT 
...
module WorkloadArchitecturalDesign =
  struct
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "The URL of the architectural design for the workload."]
...
module WorkloadDescription =
  struct
    type nonrec t = string[@@ocaml.doc "The description for the workload."]
...
module WorkloadIndustry =
  struct
    type nonrec t = string[@@ocaml.doc "The industry for the workload."]
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "The industry for the workload."]
...
module PillarDifference =
  struct
    type nonrec t =
      ...
      pillarName: PillarName.t option ;
      differenceStatus: DifferenceStatus.t option
        [@ocaml.doc "Indicates the type of change to the pillar."];
      questionDifferences: QuestionDifferences.t option
        [@ocaml.doc "List of question differences."]}
    let make ?pillarId =
      fun ?pillarName ->
        fun ?differenceStatus ->
...
module ExceptionResourceId =
  struct
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "Identifier of the resource affected."]
module ExceptionResourceType =
  struct
    type nonrec t = string[@@ocaml.doc "Type of the resource affected."]
    ...
    let to_json = simple_to_json to_value
  end[@@ocaml.doc "Type of the resource affected."]
module QuotaCode =
  struct
    type nonrec t = string[@@ocaml.doc
...
module ChoiceUpdate =
  struct
    type nonrec t =
      {
      status: ChoiceStatus.t [@ocaml.doc "The status of a choice."];
      reason: ChoiceReason.t option
        [@ocaml.doc
          "The reason why a choice is non-applicable to a question in your workload."];
      notes: ChoiceNotes.t option
  ...
  struct
    type nonrec t =
      ...
      lensUpgradeSummary: LensUpgradeSummary.t option
        [@ocaml.doc "Summary of lens upgrade."]}
    let make ?type_ =
...
module LensSummary =
  struct
    type nonrec t =
      {
      lensArn: LensArn.t option [@ocaml.doc "The ARN of the lens."];
      lensAlias: LensAlias.t option ;
      lensName: LensName.t option ;
      lensType: LensType.t option [@ocaml.doc "The type of the lens."];
    ...
    let of_json json =
      ...
      make ?lensStatus ?owner ?lensVersion ?updatedAt ?createdAt ?description
        ?lensType ?lensName ?lensAlias ?lensArn ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "A lens summary of a lens."]
...
module Lens =
  struct
    type nonrec t =
      {
      lensArn: LensArn.t option [@ocaml.doc "The ARN of a lens."];
      lensVersion: LensVersion.t option [@ocaml.doc "The version of a lens."];
  ...
  struct
    ...
    let of_json json =
      ...
      make ?improvementStatus ?notes ?industry ?industryType
        ...
        ?description ?workloadName ~workloadId ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Input to update a workload."]
  ...
  struct
    ...
    let of_json json =
      ...
      make ?reason ?isApplicable ?notes ?choiceUpdates ?selectedChoices
        ~questionId ~lensAlias ~workloadId ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Input to update answer."]
  ...
  struct
    type nonrec t =
      ...
      shareInvitationSummaries: ShareInvitationSummaries.t option
        [@ocaml.doc "List of share invitation summaries in a workload."];
      nextToken: NextToken.t option }
    type nonrec error =
      [ `AccessDeniedException of AccessDeniedException.t 
      | `InternalServerException of InternalServerException.t 
...
module ListShareInvitationsInput =
  struct
    type nonrec t =
      ...
      shareResourceType: ShareResourceType.t option
        [@ocaml.doc "The type of share invitations to be returned."];
      nextToken: NextToken.t option ;
  ...
  struct
    type nonrec t =
      ...
      notificationSummaries: NotificationSummaries.t option
        [@ocaml.doc "List of lens notification summaries in a workload."];
      nextToken: NextToken.t option }
    type nonrec error =
      [ `AccessDeniedException of AccessDeniedException.t 
      | `InternalServerException of InternalServerException.t 
  ...
  struct
    type nonrec t =
      ...
      lensType: LensType.t option
        [@ocaml.doc "The type of lenses to be returned."];
      lensStatus: LensStatusType.t option
        [@ocaml.doc "The status of lenses to be returned."];
      lensName: LensName.t option }
    let make ?nextToken =
      fun ?maxResults ->
        fun ?lensType ->
  ...
  struct
    type nonrec t =
      ...
      lensShareSummaries: LensShareSummaries.t option
        [@ocaml.doc "A list of lens share summaries."];
      nextToken: NextToken.t option }
    type nonrec error =
      [ `AccessDeniedException of AccessDeniedException.t 
      | `InternalServerException of InternalServerException.t 
  ...
  struct
    ...
    let of_json json =
      ...
      make ?nextToken ?improvementSummaries ?lensArn ?lensAlias
        ?milestoneNumber ?workloadId ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Output of a list lens review improvements call."]
  ...
  struct
    ...
    let of_json json =
      ...
      make ?nextToken ?answerSummaries ?lensArn ?lensAlias ?milestoneNumber
        ?workloadId ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Output of a list answers call."]
...
module ImportLensInput =
  struct
    type nonrec t =
      ...
      tags: TagMap.t option [@ocaml.doc "Tags to associate to a lens."]}
  ...
  struct
    type nonrec t =
      ...
      baseLensVersion: LensVersion.t option
        [@ocaml.doc "The base version of the lens."];
      targetLensVersion: LensVersion.t option
        [@ocaml.doc "The target lens version for the lens."];
      latestLensVersion: LensVersion.t option
        [@ocaml.doc "The latest version of the lens."];
  ...
  struct
    type nonrec t =
      ...
      baseLensVersion: LensVersion.t option
        [@ocaml.doc "The base version of the lens."];
      targetLensVersion: LensVersion.t option
        [@ocaml.doc "The lens version to target a difference for."]}
...
module GetLensOutput =
  struct
    type nonrec t =
      {
      lens: Lens.t option [@ocaml.doc "A lens return object."]}
    type nonrec error =
      [ `AccessDeniedException of AccessDeniedException.t 
      | `InternalServerException of InternalServerException.t 
      | `ResourceNotFoundException of ResourceNotFoundException.t 
...
module GetLensInput =
  struct
    type nonrec t =
      ...
      lensAlias: LensAlias.t ;
      lensVersion: LensVersion.t option
        [@ocaml.doc "The lens version to be retrieved."]}
...
module ExportLensInput =
  struct
    type nonrec t =
      ...
      lensAlias: LensAlias.t ;
      lensVersion: LensVersion.t option
        [@ocaml.doc "The lens version to be exported."]}
  ...
  struct
    type nonrec t =
      ...
      lensStatus: LensStatusType.t
        [@ocaml.doc "The status of the lens to be deleted."]}
  ...
  struct
    type nonrec t =
      ...
      lensVersion: LensVersion.t
        [@ocaml.doc "The version of the lens being created."];
      isMajorVersion: IsMajorVersion.t option
        [@ocaml.doc "Set to true if this new major lens version."];
      clientRequestToken: ClientRequestToken.t }
