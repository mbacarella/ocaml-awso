...
let get_media =
  Command.async ~summary:""
    ([%map_open.Command
       ...
       and startSelector =
         flag "start-selector" (required json_arg) ~doc:"JSON StartSelector" in
       fun () ->
         call ?endpoint_url ?profile:cli_profile ?region:cli_region
           Io.get_media
           (Values.GetMediaInput.make ?streamName ?streamARN
              ~startSelector:(Values.StartSelector.of_json startSelector) ())
           (Some Values.GetMediaOutput.to_json)
