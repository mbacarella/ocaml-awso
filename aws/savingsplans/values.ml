...
module ParentSavingsPlanOffering =
  struct
    type nonrec t =
      ...
      planType: SavingsPlanType.t option ;
...
module SavingsPlan =
  struct
    type nonrec t =
      ...
      start: String_.t option ;
      end_: String_.t option ;
      state: SavingsPlanState.t option ;
      region: Region.t option ;
      ec2InstanceFamily: EC2InstanceFamily.t option ;
      savingsPlanType: SavingsPlanType.t option ;
      paymentOption: SavingsPlanPaymentOption.t option ;
...
module SavingsPlanFilter =
  struct
    type nonrec t =
      {
      name: SavingsPlansFilterName.t option ;
      values: ListOfStrings.t option }
...
module SavingsPlanOfferingFilterElement =
  struct
    type nonrec t =
      ...
      values: FilterValuesList.t option }
    let make ?name = fun ?values -> fun () -> { name; values }
    let to_value x =
      structure_to_value
        [("name",
...
module SavingsPlanOfferingRate =
  struct
    type nonrec t =
      ...
      unit: SavingsPlanRateUnit.t option ;
...
module DescribeSavingsPlansRequest =
  struct
    type nonrec t =
      ...
      filters: SavingsPlanFilterList.t option }
...
module DescribeSavingsPlansOfferingsRequest =
  struct
    type nonrec t =
      {
      offeringIds: UUIDs.t option ;
      paymentOptions: SavingsPlanPaymentOptionList.t option ;
      productType: SavingsPlanProductType.t option ;
      planTypes: SavingsPlanTypeList.t option ;
      durations: DurationsList.t option ;
      currencies: CurrencyList.t option ;
...
module DescribeSavingsPlanRatesRequest =
  struct
    type nonrec t =
      ...
      filters: SavingsPlanRateFilterList.t option ;
      nextToken: PaginationToken.t option ;
      maxResults: MaxResults.t option }
