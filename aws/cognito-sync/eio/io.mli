    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListIdentityPoolUsageRequest.t ->
        (ListIdentityPoolUsageResponse.t,
          ListIdentityPoolUsageResponse.error) Result.t
val list_records :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
...
val set_cognito_events :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> SetCognitoEventsRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      UnsubscribeFromDatasetRequest.t ->
        (UnsubscribeFromDatasetResponse.t,
          UnsubscribeFromDatasetResponse.error) Result.t
val update_records :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
