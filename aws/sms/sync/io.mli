    ...
    ?cfg:Awso.Cfg.t ->
      DisassociateConnectorRequest.t ->
        (DisassociateConnectorResponse.t,
          DisassociateConnectorResponse.error) Result.t
...
val get_app :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetAppRequest.t -> (GetAppResponse.t, GetAppResponse.error) Result.t
val get_app_launch_configuration :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetAppLaunchConfigurationRequest.t ->
        (GetAppLaunchConfigurationResponse.t,
          GetAppLaunchConfigurationResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetAppValidationOutputRequest.t ->
        (GetAppValidationOutputResponse.t,
          GetAppValidationOutputResponse.error) Result.t
val get_connectors :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
