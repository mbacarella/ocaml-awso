...
val attach_instances :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AttachInstancesQuery.t -> (unit, unit) Result.t
...
val create_auto_scaling_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> CreateAutoScalingGroupType.t -> (unit, unit) Result.t
...
val create_or_update_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> CreateOrUpdateTagsType.t -> (unit, unit) Result.t
val delete_auto_scaling_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteAutoScalingGroupType.t -> (unit, unit) Result.t
val delete_launch_configuration :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> LaunchConfigurationNameType.t -> (unit, unit) Result.t
...
val delete_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeletePolicyType.t -> (unit, unit) Result.t
val delete_scheduled_action :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteScheduledActionType.t -> (unit, unit) Result.t
val delete_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteTagsType.t -> (unit, unit) Result.t
...
val execute_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ExecutePolicyType.t -> (unit, unit) Result.t
val exit_standby :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ExitStandbyQuery.t ->
...
val resume_processes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ScalingProcessQuery.t -> (unit, unit) Result.t
...
val set_desired_capacity :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetDesiredCapacityType.t -> (unit, unit) Result.t
val set_instance_health :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetInstanceHealthQuery.t -> (unit, unit) Result.t
...
val update_auto_scaling_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateAutoScalingGroupType.t -> (unit, unit) Result.t