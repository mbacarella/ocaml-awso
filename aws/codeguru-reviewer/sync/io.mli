    ...
    ?cfg:Awso.Cfg.t ->
      DisassociateRepositoryRequest.t ->
        (DisassociateRepositoryResponse.t,
          DisassociateRepositoryResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListRecommendationFeedbackRequest.t ->
        (ListRecommendationFeedbackResponse.t,
          ListRecommendationFeedbackResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListRepositoryAssociationsRequest.t ->
        (ListRepositoryAssociationsResponse.t,
          ListRepositoryAssociationsResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      PutRecommendationFeedbackRequest.t ->
        (PutRecommendationFeedbackResponse.t,
          PutRecommendationFeedbackResponse.error) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
