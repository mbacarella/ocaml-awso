...
module NodeInputPort =
  struct
    type nonrec t =
      ...
      name: PortName.t option ;
      type_: PortType.t option }
...
module PackageListItem =
  struct
    type nonrec t =
      {
      arn: NodePackageArn.t option ;
      createdTime: TimeStamp.t option ;
      packageId: NodePackageId.t option ;
...
module PackageImportJob =
  struct
    type nonrec t =
      ...
      jobType: PackageImportJobType.t option ;
...
module JobResourceTags =
  struct
    type nonrec t = {
      resourceType: JobResourceType.t ;
      tags: TagMap.t }
...
module NodeInterface =
  struct
    type nonrec t = {
      inputs: InputPortList.t ;
      outputs: OutputPortList.t }
...
module ListDevicesJobsResponse =
  struct
    type nonrec t =
      {
      deviceJobs: DeviceJobList.t option ;
      nextToken: NextToken.t option }
    type nonrec error =
      [ `AccessDeniedException of AccessDeniedException.t 
      | `ConflictException of ConflictException.t 
...
module DescribePackageImportJobResponse =
  struct
    type nonrec t =
      ...
      output: PackageImportJobOutput.t ;
      outputConfig: PackageImportJobOutputConfig.t ;
      status: PackageImportJobStatus.t ;
...
module DescribeNodeResponse =
  struct
    type nonrec t =
      {
      assetName: NodeAssetName.t option ;
      category: NodeCategory.t ;
      createdTime: TimeStamp.t ;
...
module DescribeNodeFromTemplateJobResponse =
  struct
    type nonrec t =
      ...
      status: NodeFromTemplateJobStatus.t ;
