...
module EndpointDetails =
  struct
    type nonrec t =
      {
      endpoint: DataflowEndpoint.t option ;
...
module SatelliteListItem =
  struct
    type nonrec t =
      ...
      satelliteArn: SatelliteArn.t option ;
...
module ReserveContactRequest =
  struct
    type nonrec t =
      {
      endTime: Timestamp.t ;
      groundStation: String_.t ;
      missionProfileArn: MissionProfileArn.t ;
      satelliteArn: SatelliteArn.t ;
...
module ListSatellitesResponse =
  struct
    type nonrec t =
      ...
      satellites: SatelliteList.t option }
    type nonrec error =
      [ `DependencyException of DependencyException.t 
      | `InvalidParameterException of InvalidParameterException.t 
      | `ResourceNotFoundException of ResourceNotFoundException.t 
...
module ListContactsResponse =
  struct
    type nonrec t =
      {
      contactList: ContactList.t option ;
      nextToken: String_.t option }
    type nonrec error =
      [ `DependencyException of DependencyException.t 
      | `InvalidParameterException of InvalidParameterException.t 
...
module ListConfigsResponse =
  struct
    type nonrec t =
      {
      configList: ConfigList.t option ;
      nextToken: String_.t option }
    type nonrec error =
      [ `DependencyException of DependencyException.t 
      | `InvalidParameterException of InvalidParameterException.t 
