...
val delete_alias :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteAliasInput.t -> (unit, unit) Result.t
val delete_build :
  ?endpoint_url:string ->
...
val delete_scaling_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteScalingPolicyInput.t -> (unit, unit) Result.t
val delete_script :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteScriptInput.t -> (unit, unit) Result.t
