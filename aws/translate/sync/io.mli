...
val delete_terminology :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteTerminologyRequest.t -> (unit, unit) Result.t
val describe_text_translation_job :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeTextTranslationJobRequest.t ->
        (DescribeTextTranslationJobResponse.t,
          DescribeTextTranslationJobResponse.error) Result.t
