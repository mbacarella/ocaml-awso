...
val add_permission :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AddPermissionInput.t -> (unit, unit) Result.t
...
val delete_topic :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteTopicInput.t -> (unit, unit) Result.t
...
val remove_permission :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> RemovePermissionInput.t -> (unit, unit) Result.t
val set_endpoint_attributes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetEndpointAttributesInput.t -> (unit, unit) Result.t
...
val set_topic_attributes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetTopicAttributesInput.t -> (unit, unit) Result.t
val subscribe :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SubscribeInput.t ->
...
val unsubscribe :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UnsubscribeInput.t -> (unit, unit) Result.t
val untag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
