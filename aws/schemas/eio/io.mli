...
val delete_discoverer :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteDiscovererRequest.t -> (unit, unit) Result.t
val delete_registry :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteRegistryRequest.t -> (unit, unit) Result.t
...
val delete_schema_version :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteSchemaVersionRequest.t -> (unit, unit) Result.t
