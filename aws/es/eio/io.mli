...
val add_tags :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> AddTagsRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      CreateElasticsearchDomainRequest.t ->
        (CreateElasticsearchDomainResponse.t,
          CreateElasticsearchDomainResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DeleteElasticsearchDomainRequest.t ->
        (DeleteElasticsearchDomainResponse.t,
          DeleteElasticsearchDomainResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DescribeElasticsearchDomainRequest.t ->
        (DescribeElasticsearchDomainResponse.t,
          DescribeElasticsearchDomainResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      GetCompatibleElasticsearchVersionsRequest.t ->
        (GetCompatibleElasticsearchVersionsResponse.t,
          GetCompatibleElasticsearchVersionsResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListElasticsearchInstanceTypesRequest.t ->
        (ListElasticsearchInstanceTypesResponse.t,
          ListElasticsearchInstanceTypesResponse.error) Result.t
val list_elasticsearch_versions :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      ListElasticsearchVersionsRequest.t ->
        (ListElasticsearchVersionsResponse.t,
          ListElasticsearchVersionsResponse.error) Result.t
...
val remove_tags :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> RemoveTagsRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      UpdateElasticsearchDomainConfigRequest.t ->
        (UpdateElasticsearchDomainConfigResponse.t,
          UpdateElasticsearchDomainConfigResponse.error) Result.t
val update_package :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
    ...
    ?cfg:Awso_eio.Cfg.t ->
      UpgradeElasticsearchDomainRequest.t ->
        (UpgradeElasticsearchDomainResponse.t,
          UpgradeElasticsearchDomainResponse.error) Result.t