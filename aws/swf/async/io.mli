...
val delete_activity_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteActivityTypeInput.t -> (unit, unit) Result.t Async.Deferred.t
val delete_workflow_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteWorkflowTypeInput.t -> (unit, unit) Result.t Async.Deferred.t
val deprecate_activity_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeprecateActivityTypeInput.t -> (unit, unit) Result.t Async.Deferred.t
val deprecate_domain :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeprecateDomainInput.t -> (unit, unit) Result.t Async.Deferred.t
val deprecate_workflow_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeprecateWorkflowTypeInput.t -> (unit, unit) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeDomainInput.t ->
        (DomainDetail.t, DomainDetail.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetWorkflowExecutionHistoryInput.t ->
        (History.t, History.error) Result.t Async.Deferred.t
...
val list_domains :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListDomainsInput.t ->
        (DomainInfos.t, DomainInfos.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PollForActivityTaskInput.t ->
        (ActivityTask.t, ActivityTask.error) Result.t Async.Deferred.t
val poll_for_decision_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PollForDecisionTaskInput.t ->
        (DecisionTask.t, DecisionTask.error) Result.t Async.Deferred.t
...
val register_activity_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RegisterActivityTypeInput.t -> (unit, unit) Result.t Async.Deferred.t
val register_domain :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RegisterDomainInput.t -> (unit, unit) Result.t Async.Deferred.t
val register_workflow_type :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RegisterWorkflowTypeInput.t -> (unit, unit) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartWorkflowExecutionInput.t ->
        (Run.t, Run.error) Result.t Async.Deferred.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val undeprecate_domain :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UndeprecateDomainInput.t -> (unit, unit) Result.t Async.Deferred.t
