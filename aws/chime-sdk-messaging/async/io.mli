...
val associate_channel_flow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AssociateChannelFlowRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val delete_channel_flow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteChannelFlowRequest.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetChannelMessageStatusRequest.t ->
        (GetChannelMessageStatusResponse.t,
          GetChannelMessageStatusResponse.error) Result.t Async.Deferred.t
