...
let put_dial_request_batch ?endpoint_url ?cfg input =
  eval ?endpoint_url ?cfg Endpoints.PutDialRequestBatch input
...
let update_campaign_dialer_config ?endpoint_url ?cfg input =
  eval ?endpoint_url ?cfg Endpoints.UpdateCampaignDialerConfig input
let update_campaign_name ?endpoint_url ?cfg input =
  eval ?endpoint_url ?cfg Endpoints.UpdateCampaignName input
let update_campaign_outbound_call_config ?endpoint_url ?cfg input =
  eval ?endpoint_url ?cfg Endpoints.UpdateCampaignOutboundCallConfig input