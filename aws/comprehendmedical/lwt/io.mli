...
val detect_p_h_i :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DetectPHIRequest.t ->
        (DetectPHIResponse.t, DetectPHIResponse.error) Result.t Lwt.t
val infer_i_c_d10_c_m :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      InferICD10CMRequest.t ->
        (InferICD10CMResponse.t, InferICD10CMResponse.error) Result.t Lwt.t
val infer_rx_norm :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      InferRxNormRequest.t ->
        (InferRxNormResponse.t, InferRxNormResponse.error) Result.t Lwt.t
val infer_s_n_o_m_e_d_c_t :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      InferSNOMEDCTRequest.t ->
        (InferSNOMEDCTResponse.t, InferSNOMEDCTResponse.error) Result.t Lwt.t
val list_entities_detection_v2_jobs :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListEntitiesDetectionV2JobsRequest.t ->
        (ListEntitiesDetectionV2JobsResponse.t,
          ListEntitiesDetectionV2JobsResponse.error) Result.t Lwt.t
val list_i_c_d10_c_m_inference_jobs :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListICD10CMInferenceJobsRequest.t ->
        (ListICD10CMInferenceJobsResponse.t,
          ListICD10CMInferenceJobsResponse.error) Result.t Lwt.t
