    ...
    ?cfg:Awso.Cfg.t ->
      DescribeInstancePropertiesRequest.t ->
        (DescribeInstancePropertiesResult.t,
          DescribeInstancePropertiesResult.error) Result.t Async.Deferred.t
...
val list_nodes :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListNodesRequest.t ->
        (ListNodesResult.t, ListNodesResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartExecutionPreviewRequest.t ->
        (StartExecutionPreviewResponse.t,
          StartExecutionPreviewResponse.error) Result.t Async.Deferred.t
val start_session :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
