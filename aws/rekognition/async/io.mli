...
val associate_faces :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AssociateFacesRequest.t ->
        (AssociateFacesResponse.t, AssociateFacesResponse.error) Result.t
          Async.Deferred.t
val compare_faces :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CompareFacesRequest.t ->
        (CompareFacesResponse.t, CompareFacesResponse.error) Result.t
          Async.Deferred.t
val copy_project_version :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CopyProjectVersionRequest.t ->
        (CopyProjectVersionResponse.t, CopyProjectVersionResponse.error)
    ...
    ?cfg:Awso.Cfg.t ->
      CreateDatasetRequest.t ->
        (CreateDatasetResponse.t, CreateDatasetResponse.error) Result.t
          Async.Deferred.t
val create_face_liveness_session :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateFaceLivenessSessionRequest.t ->
        (CreateFaceLivenessSessionResponse.t,
          CreateFaceLivenessSessionResponse.error) Result.t Async.Deferred.t
val create_project :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      CreateStreamProcessorRequest.t ->
        (CreateStreamProcessorResponse.t,
          CreateStreamProcessorResponse.error) Result.t Async.Deferred.t
val create_user :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateUserRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteProjectRequest.t ->
        (DeleteProjectResponse.t, DeleteProjectResponse.error) Result.t
          Async.Deferred.t
val delete_project_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteProjectPolicyRequest.t ->
        (DeleteProjectPolicyResponse.t, DeleteProjectPolicyResponse.error)
          Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteStreamProcessorRequest.t ->
        (DeleteStreamProcessorResponse.t,
          DeleteStreamProcessorResponse.error) Result.t Async.Deferred.t
val delete_user :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteUserRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeProjectVersionsRequest.t ->
        (DescribeProjectVersionsResponse.t,
          DescribeProjectVersionsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeStreamProcessorRequest.t ->
        (DescribeStreamProcessorResponse.t,
          DescribeStreamProcessorResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DetectModerationLabelsRequest.t ->
        (DetectModerationLabelsResponse.t,
          DetectModerationLabelsResponse.error) Result.t Async.Deferred.t
val detect_protective_equipment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DetectProtectiveEquipmentRequest.t ->
        (DetectProtectiveEquipmentResponse.t,
          DetectProtectiveEquipmentResponse.error) Result.t Async.Deferred.t
val detect_text :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DetectTextRequest.t ->
        (DetectTextResponse.t, DetectTextResponse.error) Result.t
          Async.Deferred.t
val disassociate_faces :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DisassociateFacesRequest.t ->
        (DisassociateFacesResponse.t, DisassociateFacesResponse.error)
          Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DistributeDatasetEntriesRequest.t ->
        (DistributeDatasetEntriesResponse.t,
          DistributeDatasetEntriesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetCelebrityRecognitionRequest.t ->
        (GetCelebrityRecognitionResponse.t,
          GetCelebrityRecognitionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetFaceDetectionRequest.t ->
        (GetFaceDetectionResponse.t, GetFaceDetectionResponse.error) Result.t
          Async.Deferred.t
val get_face_liveness_session_results :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetFaceLivenessSessionResultsRequest.t ->
        (GetFaceLivenessSessionResultsResponse.t,
          GetFaceLivenessSessionResultsResponse.error) Result.t
          Async.Deferred.t
val get_face_search :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetLabelDetectionRequest.t ->
        (GetLabelDetectionResponse.t, GetLabelDetectionResponse.error)
          Result.t Async.Deferred.t
val get_media_analysis_job :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetMediaAnalysisJobRequest.t ->
        (GetMediaAnalysisJobResponse.t, GetMediaAnalysisJobResponse.error)
          Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListFacesRequest.t ->
        (ListFacesResponse.t, ListFacesResponse.error) Result.t
          Async.Deferred.t
val list_media_analysis_jobs :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListMediaAnalysisJobsRequest.t ->
        (ListMediaAnalysisJobsResponse.t,
          ListMediaAnalysisJobsResponse.error) Result.t Async.Deferred.t
val list_project_policies :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListProjectPoliciesRequest.t ->
        (ListProjectPoliciesResponse.t, ListProjectPoliciesResponse.error)
          Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListUsersRequest.t ->
        (ListUsersResponse.t, ListUsersResponse.error) Result.t
          Async.Deferred.t
val put_project_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutProjectPolicyRequest.t ->
        (PutProjectPolicyResponse.t, PutProjectPolicyResponse.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      SearchUsersRequest.t ->
        (SearchUsersResponse.t, SearchUsersResponse.error) Result.t
          Async.Deferred.t
val search_users_by_image :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SearchUsersByImageRequest.t ->
        (SearchUsersByImageResponse.t, SearchUsersByImageResponse.error)
          Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartCelebrityRecognitionRequest.t ->
        (StartCelebrityRecognitionResponse.t,
          StartCelebrityRecognitionResponse.error) Result.t Async.Deferred.t
val start_content_moderation :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartContentModerationRequest.t ->
        (StartContentModerationResponse.t,
          StartContentModerationResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartLabelDetectionRequest.t ->
        (StartLabelDetectionResponse.t, StartLabelDetectionResponse.error)
          Result.t Async.Deferred.t
val start_media_analysis_job :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartMediaAnalysisJobRequest.t ->
        (StartMediaAnalysisJobResponse.t,
          StartMediaAnalysisJobResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartSegmentDetectionRequest.t ->
        (StartSegmentDetectionResponse.t,
          StartSegmentDetectionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateDatasetEntriesRequest.t ->
        (UpdateDatasetEntriesResponse.t, UpdateDatasetEntriesResponse.error)
          Result.t Async.Deferred.t
val update_stream_processor :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateStreamProcessorRequest.t ->
        (UpdateStreamProcessorResponse.t,
          UpdateStreamProcessorResponse.error) Result.t Async.Deferred.t