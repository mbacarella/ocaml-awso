    ...
    ?cfg:Awso.Cfg.t ->
      CreateFaceLivenessSessionRequest.t ->
        (CreateFaceLivenessSessionResponse.t,
          CreateFaceLivenessSessionResponse.error) Result.t Lwt.t
val create_project :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetFaceLivenessSessionResultsRequest.t ->
        (GetFaceLivenessSessionResultsResponse.t,
          GetFaceLivenessSessionResultsResponse.error) Result.t Lwt.t
val get_face_search :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListMediaAnalysisJobsRequest.t ->
        (ListMediaAnalysisJobsResponse.t,
          ListMediaAnalysisJobsResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartMediaAnalysisJobRequest.t ->
        (StartMediaAnalysisJobResponse.t,
          StartMediaAnalysisJobResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateStreamProcessorRequest.t ->
        (UpdateStreamProcessorResponse.t,
          UpdateStreamProcessorResponse.error) Result.t Lwt.t