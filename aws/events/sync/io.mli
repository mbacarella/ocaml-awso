...
val activate_event_source :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ActivateEventSourceRequest.t -> (unit, unit) Result.t
val cancel_replay :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val delete_event_bus :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteEventBusRequest.t -> (unit, unit) Result.t
...
val disable_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DisableRuleRequest.t -> (unit, unit) Result.t
val enable_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> EnableRuleRequest.t -> (unit, unit) Result.t
...
val put_permission :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutPermissionRequest.t -> (unit, unit) Result.t
val put_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
