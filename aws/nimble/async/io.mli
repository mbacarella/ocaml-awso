    ...
    ?cfg:Awso.Cfg.t ->
      CreateStreamingSessionRequest.t ->
        (CreateStreamingSessionResponse.t,
          CreateStreamingSessionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateStudioComponentRequest.t ->
        (CreateStudioComponentResponse.t,
          CreateStudioComponentResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteLaunchProfileMemberRequest.t ->
        (DeleteLaunchProfileMemberResponse.t,
          DeleteLaunchProfileMemberResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteStreamingSessionRequest.t ->
        (DeleteStreamingSessionResponse.t,
          DeleteStreamingSessionResponse.error) Result.t Async.Deferred.t
val delete_studio :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteStudioComponentRequest.t ->
        (DeleteStudioComponentResponse.t,
          DeleteStudioComponentResponse.error) Result.t Async.Deferred.t
...
val get_eula :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetEulaRequest.t ->
        (GetEulaResponse.t, GetEulaResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLaunchProfileDetailsRequest.t ->
        (GetLaunchProfileDetailsResponse.t,
          GetLaunchProfileDetailsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLaunchProfileMemberRequest.t ->
        (GetLaunchProfileMemberResponse.t,
          GetLaunchProfileMemberResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetStreamingSessionStreamRequest.t ->
        (GetStreamingSessionStreamResponse.t,
          GetStreamingSessionStreamResponse.error) Result.t Async.Deferred.t
val get_studio :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetStudioRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListLaunchProfileMembersRequest.t ->
        (ListLaunchProfileMembersResponse.t,
          ListLaunchProfileMembersResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListStreamingSessionsRequest.t ->
        (ListStreamingSessionsResponse.t,
          ListStreamingSessionsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      PutLaunchProfileMembersRequest.t ->
        (PutLaunchProfileMembersResponse.t,
          PutLaunchProfileMembersResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartStreamingSessionRequest.t ->
        (StartStreamingSessionResponse.t,
          StartStreamingSessionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateLaunchProfileMemberRequest.t ->
        (UpdateLaunchProfileMemberResponse.t,
          UpdateLaunchProfileMemberResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateStudioComponentRequest.t ->
        (UpdateStudioComponentResponse.t,
          UpdateStudioComponentResponse.error) Result.t Async.Deferred.t