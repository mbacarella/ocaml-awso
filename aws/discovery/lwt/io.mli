    ...
    ?cfg:Awso.Cfg.t ->
      BatchDeleteImportDataRequest.t ->
        (BatchDeleteImportDataResponse.t,
          BatchDeleteImportDataResponse.error) Result.t Lwt.t
...
val create_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateTagsRequest.t ->
        (CreateTagsResponse.t, CreateTagsResponse.error) Result.t Lwt.t
...
val delete_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteTagsRequest.t ->
        (DeleteTagsResponse.t, DeleteTagsResponse.error) Result.t Lwt.t
val describe_agents :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      StopDataCollectionByAgentIdsRequest.t ->
        (StopDataCollectionByAgentIdsResponse.t,
          StopDataCollectionByAgentIdsResponse.error) Result.t Lwt.t
