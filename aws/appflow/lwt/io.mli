    ...
    ?cfg:Awso.Cfg.t ->
      CreateConnectorProfileRequest.t ->
        (CreateConnectorProfileResponse.t,
          CreateConnectorProfileResponse.error) Result.t Lwt.t
val create_flow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateFlowRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteConnectorProfileRequest.t ->
        (DeleteConnectorProfileResponse.t,
          DeleteConnectorProfileResponse.error) Result.t Lwt.t
val delete_flow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteFlowRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeConnectorEntityRequest.t ->
        (DescribeConnectorEntityResponse.t,
          DescribeConnectorEntityResponse.error) Result.t Lwt.t
val describe_connector_profiles :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeConnectorProfilesRequest.t ->
        (DescribeConnectorProfilesResponse.t,
          DescribeConnectorProfilesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeFlowExecutionRecordsRequest.t ->
        (DescribeFlowExecutionRecordsResponse.t,
          DescribeFlowExecutionRecordsResponse.error) Result.t Lwt.t
val list_connector_entities :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListConnectorEntitiesRequest.t ->
        (ListConnectorEntitiesResponse.t,
          ListConnectorEntitiesResponse.error) Result.t Lwt.t
val list_connectors :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ResetConnectorMetadataCacheRequest.t ->
        (ResetConnectorMetadataCacheResponse.t,
          ResetConnectorMetadataCacheResponse.error) Result.t Lwt.t
val start_flow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartFlowRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateConnectorProfileRequest.t ->
        (UpdateConnectorProfileResponse.t,
          UpdateConnectorProfileResponse.error) Result.t Lwt.t
val update_connector_registration :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateConnectorRegistrationRequest.t ->
        (UpdateConnectorRegistrationResponse.t,
          UpdateConnectorRegistrationResponse.error) Result.t Lwt.t
val update_flow :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateFlowRequest.t ->
