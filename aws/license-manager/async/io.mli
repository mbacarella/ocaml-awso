    ...
    ?cfg:Awso.Cfg.t ->
      CreateLicenseAssetGroupRequest.t ->
        (CreateLicenseAssetGroupResponse.t,
          CreateLicenseAssetGroupResponse.error) Result.t Async.Deferred.t
val create_license_asset_ruleset :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateLicenseAssetRulesetRequest.t ->
        (CreateLicenseAssetRulesetResponse.t,
          CreateLicenseAssetRulesetResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteLicenseAssetGroupRequest.t ->
        (DeleteLicenseAssetGroupResponse.t,
          DeleteLicenseAssetGroupResponse.error) Result.t Async.Deferred.t
val delete_license_asset_ruleset :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLicenseAssetRulesetRequest.t ->
        (DeleteLicenseAssetRulesetResponse.t,
          DeleteLicenseAssetRulesetResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLicenseAssetRulesetRequest.t ->
        (GetLicenseAssetRulesetResponse.t,
          GetLicenseAssetRulesetResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListLicenseAssetGroupsRequest.t ->
        (ListLicenseAssetGroupsResponse.t,
          ListLicenseAssetGroupsResponse.error) Result.t Async.Deferred.t
val list_license_asset_rulesets :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListLicenseAssetRulesetsRequest.t ->
        (ListLicenseAssetRulesetsResponse.t,
          ListLicenseAssetRulesetsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateLicenseAssetGroupRequest.t ->
        (UpdateLicenseAssetGroupResponse.t,
          UpdateLicenseAssetGroupResponse.error) Result.t Async.Deferred.t
val update_license_asset_ruleset :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateLicenseAssetRulesetRequest.t ->
        (UpdateLicenseAssetRulesetResponse.t,
          UpdateLicenseAssetRulesetResponse.error) Result.t Async.Deferred.t
