...
val admin_add_user_to_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AdminAddUserToGroupRequest.t -> (unit, unit) Result.t
...
val admin_delete_user :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AdminDeleteUserRequest.t -> (unit, unit) Result.t
...
val admin_forget_device :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AdminForgetDeviceRequest.t -> (unit, unit) Result.t
...
val delete_resource_server :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteResourceServerRequest.t -> (unit, unit) Result.t
val delete_terms :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteTermsRequest.t -> (unit, unit) Result.t
val delete_user :
  ?endpoint_url:string ->
...
val delete_user_pool :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteUserPoolRequest.t -> (unit, unit) Result.t
val delete_user_pool_client :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteUserPoolClientRequest.t -> (unit, unit) Result.t
...
val forget_device :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ForgetDeviceRequest.t -> (unit, unit) Result.t
val forgot_password :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
