    ...
    ?cfg:Awso.Cfg.t ->
      AddUserPoolClientSecretRequest.t ->
        (AddUserPoolClientSecretResponse.t,
          AddUserPoolClientSecretResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateManagedLoginBrandingRequest.t ->
        (CreateManagedLoginBrandingResponse.t,
          CreateManagedLoginBrandingResponse.error) Result.t Async.Deferred.t
...
val delete_managed_login_branding :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteManagedLoginBrandingRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
...
val delete_terms :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteTermsRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_user :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteUserPoolClientSecretRequest.t ->
        (DeleteUserPoolClientSecretResponse.t,
          DeleteUserPoolClientSecretResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteWebAuthnCredentialRequest.t ->
        (DeleteWebAuthnCredentialResponse.t,
          DeleteWebAuthnCredentialResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetTokensFromRefreshTokenRequest.t ->
        (GetTokensFromRefreshTokenResponse.t,
          GetTokensFromRefreshTokenResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListUserPoolClientSecretsRequest.t ->
        (ListUserPoolClientSecretsResponse.t,
          ListUserPoolClientSecretsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListWebAuthnCredentialsRequest.t ->
        (ListWebAuthnCredentialsResponse.t,
          ListWebAuthnCredentialsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartWebAuthnRegistrationRequest.t ->
        (StartWebAuthnRegistrationResponse.t,
          StartWebAuthnRegistrationResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateManagedLoginBrandingRequest.t ->
        (UpdateManagedLoginBrandingResponse.t,
          UpdateManagedLoginBrandingResponse.error) Result.t Async.Deferred.t
