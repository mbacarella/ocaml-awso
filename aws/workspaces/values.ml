...
module WorkspaceImage =
  struct
    type nonrec t =
      ...
      name: WorkspaceImageName.t option ;
...
module WorkspacesIpGroup =
  struct
    type nonrec t =
      {
      groupId: IpGroupId.t option ;
      groupName: IpGroupName.t option ;
