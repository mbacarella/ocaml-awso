...
val associate_assets :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AssociateAssetsRequest.t -> (unit, unit) Result.t
...
val delete_gateway :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteGatewayRequest.t -> (unit, unit) Result.t
val delete_portal :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val delete_time_series :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteTimeSeriesRequest.t -> (unit, unit) Result.t
...
val disassociate_assets :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DisassociateAssetsRequest.t -> (unit, unit) Result.t
...
val update_asset_property :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateAssetPropertyRequest.t -> (unit, unit) Result.t
...
val update_gateway :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateGatewayRequest.t -> (unit, unit) Result.t
