...
val delete_dataset_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteDatasetGroupRequest.t -> (unit, unit) Result.t
...
val delete_explainability :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteExplainabilityRequest.t -> (unit, unit) Result.t
...
val delete_forecast :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteForecastRequest.t -> (unit, unit) Result.t
...
val delete_monitor :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteMonitorRequest.t -> (unit, unit) Result.t
val delete_predictor :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeletePredictorRequest.t -> (unit, unit) Result.t
...
val delete_resource_tree :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteResourceTreeRequest.t -> (unit, unit) Result.t
val delete_what_if_analysis :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteWhatIfAnalysisRequest.t -> (unit, unit) Result.t
val delete_what_if_forecast :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteWhatIfForecastRequest.t -> (unit, unit) Result.t
...
val resume_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ResumeResourceRequest.t -> (unit, unit) Result.t
val stop_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> StopResourceRequest.t -> (unit, unit) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
