...
val delete_event_tracker :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteEventTrackerRequest.t -> (unit, unit) Result.t
val delete_filter :
  ?endpoint_url:string ->
...
val delete_schema :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteSchemaRequest.t -> (unit, unit) Result.t
val delete_solution :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteSolutionRequest.t -> (unit, unit) Result.t
