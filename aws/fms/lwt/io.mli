    ...
    ?cfg:Awso.Cfg.t ->
      BatchAssociateResourceRequest.t ->
        (BatchAssociateResourceResponse.t,
          BatchAssociateResourceResponse.error) Result.t Lwt.t
val batch_disassociate_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      BatchDisassociateResourceRequest.t ->
        (BatchDisassociateResourceResponse.t,
          BatchDisassociateResourceResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetAdminScopeRequest.t ->
        (GetAdminScopeResponse.t, GetAdminScopeResponse.error) Result.t Lwt.t
val get_apps_list :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListAdminAccountsForOrganizationRequest.t ->
        (ListAdminAccountsForOrganizationResponse.t,
          ListAdminAccountsForOrganizationResponse.error) Result.t Lwt.t
val list_admins_managing_account :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListAdminsManagingAccountRequest.t ->
        (ListAdminsManagingAccountResponse.t,
          ListAdminsManagingAccountResponse.error) Result.t Lwt.t
val list_apps_lists :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListResourceSetResourcesRequest.t ->
        (ListResourceSetResourcesResponse.t,
          ListResourceSetResourcesResponse.error) Result.t Lwt.t
...
val put_admin_account :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutAdminAccountRequest.t -> (unit, unit) Result.t Lwt.t
val put_apps_list :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
