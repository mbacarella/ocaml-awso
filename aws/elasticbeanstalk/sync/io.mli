...
val delete_application :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteApplicationMessage.t -> (unit, unit) Result.t
...
val rebuild_environment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> RebuildEnvironmentMessage.t -> (unit, unit) Result.t
...
val restart_app_server :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> RestartAppServerMessage.t -> (unit, unit) Result.t
