    ...
    ?cfg:Awso.Cfg.t ->
      CreateServerlessCacheRequest.t ->
        (CreateServerlessCacheResponse.t,
          CreateServerlessCacheResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteServerlessCacheRequest.t ->
        (DeleteServerlessCacheResponse.t,
          DeleteServerlessCacheResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeServerlessCachesRequest.t ->
        (DescribeServerlessCachesResponse.t,
          DescribeServerlessCachesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyServerlessCacheRequest.t ->
        (ModifyServerlessCacheResponse.t,
          ModifyServerlessCacheResponse.error) Result.t Async.Deferred.t
val modify_user :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
