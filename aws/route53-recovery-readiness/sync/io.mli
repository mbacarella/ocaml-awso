...
val delete_cell :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteCellRequest.t -> (unit, unit) Result.t
...
val delete_readiness_check :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteReadinessCheckRequest.t -> (unit, unit) Result.t
val delete_recovery_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteRecoveryGroupRequest.t -> (unit, unit) Result.t
