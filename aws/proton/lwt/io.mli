    ...
    ?cfg:Awso.Cfg.t ->
      CancelComponentDeploymentInput.t ->
        (CancelComponentDeploymentOutput.t,
          CancelComponentDeploymentOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateComponentInput.t ->
        (CreateComponentOutput.t, CreateComponentOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateServiceSyncConfigInput.t ->
        (CreateServiceSyncConfigOutput.t,
          CreateServiceSyncConfigOutput.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteComponentInput.t ->
        (DeleteComponentOutput.t, DeleteComponentOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteServiceSyncConfigInput.t ->
        (DeleteServiceSyncConfigOutput.t,
          DeleteServiceSyncConfigOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetServiceInstanceSyncStatusInput.t ->
        (GetServiceInstanceSyncStatusOutput.t,
          GetServiceInstanceSyncStatusOutput.error) Result.t Lwt.t
val get_service_sync_blocker_summary :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetServiceSyncBlockerSummaryInput.t ->
        (GetServiceSyncBlockerSummaryOutput.t,
          GetServiceSyncBlockerSummaryOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListComponentProvisionedResourcesInput.t ->
        (ListComponentProvisionedResourcesOutput.t,
          ListComponentProvisionedResourcesOutput.error) Result.t Lwt.t
val list_components :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateComponentInput.t ->
        (UpdateComponentOutput.t, UpdateComponentOutput.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateServiceSyncBlockerInput.t ->
        (UpdateServiceSyncBlockerOutput.t,
          UpdateServiceSyncBlockerOutput.error) Result.t Lwt.t
val update_service_sync_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateServiceSyncConfigInput.t ->
        (UpdateServiceSyncConfigOutput.t,
          UpdateServiceSyncConfigOutput.error) Result.t Lwt.t
