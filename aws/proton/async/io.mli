    ...
    ?cfg:Awso.Cfg.t ->
      CancelComponentDeploymentInput.t ->
        (CancelComponentDeploymentOutput.t,
          CancelComponentDeploymentOutput.error) Result.t Async.Deferred.t
val cancel_environment_deployment :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CancelEnvironmentDeploymentInput.t ->
        (CancelEnvironmentDeploymentOutput.t,
          CancelEnvironmentDeploymentOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateEnvironmentTemplateInput.t ->
        (CreateEnvironmentTemplateOutput.t,
          CreateEnvironmentTemplateOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateServiceSyncConfigInput.t ->
        (CreateServiceSyncConfigOutput.t,
          CreateServiceSyncConfigOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateServiceTemplateVersionInput.t ->
        (CreateServiceTemplateVersionOutput.t,
          CreateServiceTemplateVersionOutput.error) Result.t Async.Deferred.t
val create_template_sync_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateTemplateSyncConfigInput.t ->
        (CreateTemplateSyncConfigOutput.t,
          CreateTemplateSyncConfigOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteEnvironmentTemplateInput.t ->
        (DeleteEnvironmentTemplateOutput.t,
          DeleteEnvironmentTemplateOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteServiceSyncConfigInput.t ->
        (DeleteServiceSyncConfigOutput.t,
          DeleteServiceSyncConfigOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteServiceTemplateVersionInput.t ->
        (DeleteServiceTemplateVersionOutput.t,
          DeleteServiceTemplateVersionOutput.error) Result.t Async.Deferred.t
val delete_template_sync_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteTemplateSyncConfigInput.t ->
        (DeleteTemplateSyncConfigOutput.t,
          DeleteTemplateSyncConfigOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetServiceInstanceSyncStatusInput.t ->
        (GetServiceInstanceSyncStatusOutput.t,
          GetServiceInstanceSyncStatusOutput.error) Result.t Async.Deferred.t
val get_service_sync_blocker_summary :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetServiceSyncBlockerSummaryInput.t ->
        (GetServiceSyncBlockerSummaryOutput.t,
          GetServiceSyncBlockerSummaryOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetServiceTemplateVersionInput.t ->
        (GetServiceTemplateVersionOutput.t,
          GetServiceTemplateVersionOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListEnvironmentTemplatesInput.t ->
        (ListEnvironmentTemplatesOutput.t,
          ListEnvironmentTemplatesOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListServiceInstanceOutputsInput.t ->
        (ListServiceInstanceOutputsOutput.t,
          ListServiceInstanceOutputsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListServicePipelineOutputsInput.t ->
        (ListServicePipelineOutputsOutput.t,
          ListServicePipelineOutputsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListServiceTemplateVersionsInput.t ->
        (ListServiceTemplateVersionsOutput.t,
          ListServiceTemplateVersionsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateEnvironmentTemplateInput.t ->
        (UpdateEnvironmentTemplateOutput.t,
          UpdateEnvironmentTemplateOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateServiceSyncBlockerInput.t ->
        (UpdateServiceSyncBlockerOutput.t,
          UpdateServiceSyncBlockerOutput.error) Result.t Async.Deferred.t
val update_service_sync_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateServiceSyncConfigInput.t ->
        (UpdateServiceSyncConfigOutput.t,
          UpdateServiceSyncConfigOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateServiceTemplateVersionInput.t ->
        (UpdateServiceTemplateVersionOutput.t,
          UpdateServiceTemplateVersionOutput.error) Result.t Async.Deferred.t
val update_template_sync_config :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateTemplateSyncConfigInput.t ->
        (UpdateTemplateSyncConfigOutput.t,
          UpdateTemplateSyncConfigOutput.error) Result.t Async.Deferred.t