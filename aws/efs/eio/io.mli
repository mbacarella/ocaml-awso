...
val delete_replication_configuration :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteReplicationConfigurationRequest.t -> (unit, unit) Result.t
val delete_tags :
  ?endpoint_url:string ->
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DescribeAccountPreferencesRequest.t ->
        (DescribeAccountPreferencesResponse.t,
          DescribeAccountPreferencesResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DescribeLifecycleConfigurationRequest.t ->
        (LifecycleConfigurationDescription.t,
          LifecycleConfigurationDescription.error) Result.t
...
val modify_mount_target_security_groups :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      ModifyMountTargetSecurityGroupsRequest.t -> (unit, unit) Result.t
val put_account_preferences :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      PutAccountPreferencesRequest.t ->
        (PutAccountPreferencesResponse.t,
          PutAccountPreferencesResponse.error) Result.t
