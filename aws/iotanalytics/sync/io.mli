    ...
    ?cfg:Awso.Cfg.t ->
      CancelPipelineReprocessingRequest.t ->
        (CancelPipelineReprocessingResponse.t,
          CancelPipelineReprocessingResponse.error) Result.t
val create_channel :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val delete_dataset_content :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteDatasetContentRequest.t -> (unit, unit) Result.t
val delete_datastore :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteDatastoreRequest.t -> (unit, unit) Result.t
val delete_pipeline :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeletePipelineRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartPipelineReprocessingRequest.t ->
        (StartPipelineReprocessingResponse.t,
          StartPipelineReprocessingResponse.error) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val update_channel :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateChannelRequest.t -> (unit, unit) Result.t
val update_dataset :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateDatasetRequest.t -> (unit, unit) Result.t
val update_datastore :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateDatastoreRequest.t -> (unit, unit) Result.t
val update_pipeline :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdatePipelineRequest.t -> (unit, unit) Result.t