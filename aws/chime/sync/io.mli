...
val delete_attendee :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteAttendeeRequest.t -> (unit, unit) Result.t
val delete_channel :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteChannelRequest.t -> (unit, unit) Result.t
val delete_channel_ban :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteChannelBanRequest.t -> (unit, unit) Result.t
...
val delete_channel_message :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteChannelMessageRequest.t -> (unit, unit) Result.t
...
val delete_meeting :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteMeetingRequest.t -> (unit, unit) Result.t
...
val delete_room :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteRoomRequest.t -> (unit, unit) Result.t
val delete_room_membership :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteRoomMembershipRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartMeetingTranscriptionRequest.t ->
        (StartMeetingTranscriptionResponse.t,
          StartMeetingTranscriptionResponse.error) Result.t
val stop_meeting_transcription :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopMeetingTranscriptionRequest.t ->
        (StopMeetingTranscriptionResponse.t,
          StopMeetingTranscriptionResponse.error) Result.t
val tag_attendee :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> TagAttendeeRequest.t -> (unit, unit) Result.t
val tag_meeting :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> TagMeetingRequest.t -> (unit, unit) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> TagResourceRequest.t -> (unit, unit) Result.t
val untag_attendee :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UntagAttendeeRequest.t -> (unit, unit) Result.t
val untag_meeting :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UntagMeetingRequest.t -> (unit, unit) Result.t
val untag_resource :
  ?endpoint_url:string ->
...
val update_user_settings :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateUserSettingsRequest.t -> (unit, unit) Result.t
