    ...
    ?cfg:Awso.Cfg.t ->
      CheckAccessNotGrantedRequest.t ->
        (CheckAccessNotGrantedResponse.t,
          CheckAccessNotGrantedResponse.error) Result.t Async.Deferred.t
...
val generate_finding_recommendation :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GenerateFindingRecommendationRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetFindingRecommendationRequest.t ->
        (GetFindingRecommendationResponse.t,
          GetFindingRecommendationResponse.error) Result.t Async.Deferred.t
val get_finding_v2 :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
