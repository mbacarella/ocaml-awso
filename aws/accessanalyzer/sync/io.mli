...
val apply_archive_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> ApplyArchiveRuleRequest.t -> (unit, unit) Result.t
...
val create_archive_rule :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> CreateArchiveRuleRequest.t -> (unit, unit) Result.t
val delete_analyzer :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteAnalyzerRequest.t -> (unit, unit) Result.t
...
val start_resource_scan :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> StartResourceScanRequest.t -> (unit, unit) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val update_findings :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateFindingsRequest.t -> (unit, unit) Result.t
val validate_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
