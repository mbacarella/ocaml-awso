    ...
    ?cfg:Awso.Cfg.t ->
      AssociateEntityToThingRequest.t ->
        (AssociateEntityToThingResponse.t,
          AssociateEntityToThingResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DissociateEntityFromThingRequest.t ->
        (DissociateEntityFromThingResponse.t,
          DissociateEntityFromThingResponse.error) Result.t
val get_entities :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetSystemTemplateRevisionsRequest.t ->
        (GetSystemTemplateRevisionsResponse.t,
          GetSystemTemplateRevisionsResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListFlowExecutionMessagesRequest.t ->
        (ListFlowExecutionMessagesResponse.t,
          ListFlowExecutionMessagesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      SearchSystemInstancesRequest.t ->
        (SearchSystemInstancesResponse.t,
          SearchSystemInstancesResponse.error) Result.t
val search_system_templates :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SearchSystemTemplatesRequest.t ->
        (SearchSystemTemplatesResponse.t,
          SearchSystemTemplatesResponse.error) Result.t
val search_things :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UndeploySystemInstanceRequest.t ->
        (UndeploySystemInstanceResponse.t,
          UndeploySystemInstanceResponse.error) Result.t
val untag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UploadEntityDefinitionsRequest.t ->
        (UploadEntityDefinitionsResponse.t,
          UploadEntityDefinitionsResponse.error) Result.t