    ...
    ?cfg:Awso.Cfg.t ->
      ConfigureLogsForChannelRequest.t ->
        (ConfigureLogsForChannelResponse.t,
          ConfigureLogsForChannelResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutFunctionRequest.t ->
        (PutFunctionResponse.t, PutFunctionResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateProgramRequest.t ->
        (UpdateProgramResponse.t, UpdateProgramResponse.error) Result.t Lwt.t
