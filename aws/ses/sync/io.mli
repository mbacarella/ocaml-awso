    ...
    ?cfg:Awso.Cfg.t ->
      CreateConfigurationSetTrackingOptionsRequest.t ->
        (CreateConfigurationSetTrackingOptionsResponse.t,
          CreateConfigurationSetTrackingOptionsResponse.error) Result.t
val create_custom_verification_email_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateCustomVerificationEmailTemplateRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteConfigurationSetTrackingOptionsRequest.t ->
        (DeleteConfigurationSetTrackingOptionsResponse.t,
          DeleteConfigurationSetTrackingOptionsResponse.error) Result.t
val delete_custom_verification_email_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteCustomVerificationEmailTemplateRequest.t -> (unit, unit) Result.t
val delete_identity :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeReceiptRuleSetRequest.t ->
        (DescribeReceiptRuleSetResponse.t,
          DescribeReceiptRuleSetResponse.error) Result.t
val get_account_sending_enabled :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      unit ->
        (GetAccountSendingEnabledResponse.t,
          GetAccountSendingEnabledResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetIdentityDkimAttributesRequest.t ->
        (GetIdentityDkimAttributesResponse.t,
          GetIdentityDkimAttributesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetIdentityMailFromDomainAttributesRequest.t ->
        (GetIdentityMailFromDomainAttributesResponse.t,
          GetIdentityMailFromDomainAttributesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetIdentityNotificationAttributesRequest.t ->
        (GetIdentityNotificationAttributesResponse.t,
          GetIdentityNotificationAttributesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetIdentityVerificationAttributesRequest.t ->
        (GetIdentityVerificationAttributesResponse.t,
          GetIdentityVerificationAttributesResponse.error) Result.t
val get_send_quota :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      unit -> (GetSendQuotaResponse.t, GetSendQuotaResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      unit ->
        (ListVerifiedEmailAddressesResponse.t,
          ListVerifiedEmailAddressesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ReorderReceiptRuleSetRequest.t ->
        (ReorderReceiptRuleSetResponse.t,
          ReorderReceiptRuleSetResponse.error) Result.t
val send_bounce :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SendBounceRequest.t ->
        (SendBounceResponse.t, SendBounceResponse.error) Result.t
val send_bulk_templated_email :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SendBulkTemplatedEmailRequest.t ->
        (SendBulkTemplatedEmailResponse.t,
          SendBulkTemplatedEmailResponse.error) Result.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SendRawEmailRequest.t ->
        (SendRawEmailResponse.t, SendRawEmailResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      SetIdentityFeedbackForwardingEnabledRequest.t ->
        (SetIdentityFeedbackForwardingEnabledResponse.t,
          SetIdentityFeedbackForwardingEnabledResponse.error) Result.t
...
val update_account_sending_enabled :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateAccountSendingEnabledRequest.t -> (unit, unit) Result.t
...
val update_configuration_set_sending_enabled :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateConfigurationSetSendingEnabledRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateConfigurationSetTrackingOptionsRequest.t ->
        (UpdateConfigurationSetTrackingOptionsResponse.t,
          UpdateConfigurationSetTrackingOptionsResponse.error) Result.t
val update_custom_verification_email_template :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateCustomVerificationEmailTemplateRequest.t -> (unit, unit) Result.t
...
val verify_email_address :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> VerifyEmailAddressRequest.t -> (unit, unit) Result.t
