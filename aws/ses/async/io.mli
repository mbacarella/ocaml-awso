    ...
    ?cfg:Awso.Cfg.t ->
      DescribeConfigurationSetRequest.t ->
        (DescribeConfigurationSetResponse.t,
          DescribeConfigurationSetResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeReceiptRuleSetRequest.t ->
        (DescribeReceiptRuleSetResponse.t,
          DescribeReceiptRuleSetResponse.error) Result.t Async.Deferred.t
val get_account_sending_enabled :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      unit ->
        (GetAccountSendingEnabledResponse.t,
          GetAccountSendingEnabledResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetIdentityDkimAttributesRequest.t ->
        (GetIdentityDkimAttributesResponse.t,
          GetIdentityDkimAttributesResponse.error) Result.t Async.Deferred.t
...
val get_send_quota :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      unit ->
        (GetSendQuotaResponse.t, GetSendQuotaResponse.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      unit ->
        (ListVerifiedEmailAddressesResponse.t,
          ListVerifiedEmailAddressesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ReorderReceiptRuleSetRequest.t ->
        (ReorderReceiptRuleSetResponse.t,
          ReorderReceiptRuleSetResponse.error) Result.t Async.Deferred.t
val send_bounce :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SendBounceRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      SendBulkTemplatedEmailRequest.t ->
        (SendBulkTemplatedEmailResponse.t,
          SendBulkTemplatedEmailResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      SetActiveReceiptRuleSetRequest.t ->
        (SetActiveReceiptRuleSetResponse.t,
          SetActiveReceiptRuleSetResponse.error) Result.t Async.Deferred.t
val set_identity_dkim_enabled :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SetIdentityDkimEnabledRequest.t ->
        (SetIdentityDkimEnabledResponse.t,
          SetIdentityDkimEnabledResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      SetIdentityMailFromDomainRequest.t ->
        (SetIdentityMailFromDomainResponse.t,
          SetIdentityMailFromDomainResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      SetReceiptRulePositionRequest.t ->
        (SetReceiptRulePositionResponse.t,
          SetReceiptRulePositionResponse.error) Result.t Async.Deferred.t
...
val verify_email_address :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      VerifyEmailAddressRequest.t -> (unit, unit) Result.t Async.Deferred.t
