...
module ElasticInferenceAcceleratorHealth =
  struct
    ...
    let of_json json =
      ...
      make ?status ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "The health details of an Elastic Inference Accelerator."]
module ResourceArn =
  struct
    type nonrec t = string
  ...
  struct
    type nonrec t =
      ...
      acceleratorHealth: ElasticInferenceAcceleratorHealth.t option
        [@ocaml.doc "The health of the Elastic Inference Accelerator."];
      acceleratorType: AcceleratorTypeName.t option
        [@ocaml.doc "The type of the Elastic Inference Accelerator."];
      acceleratorId: AcceleratorId.t option
        [@ocaml.doc "The ID of the Elastic Inference Accelerator."];
    ...
    let of_json json =
      ...
      make ?attachedResource ?availabilityZone ?acceleratorId
        ?acceleratorType ?acceleratorHealth ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "The details of an Elastic Inference Accelerator."]
module Filter =
  struct
    type nonrec t =
      {
  ...
  struct
    type nonrec t =
      ...
      acceleratorTypeName: AcceleratorTypeName.t option
        [@ocaml.doc "The name of the Elastic Inference Accelerator type."];
    ...
    let of_json json =
      ...
      make ?throughputInfo ?memoryInfo ?acceleratorTypeName ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "The details of an Elastic Inference Accelerator type."]
module AcceleratorTypeOffering =
  struct
    ...
    let of_json json =
      ...
      make ?location ?locationType ?acceleratorType ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "The offering for an Elastic Inference Accelerator type."]
...
module ResourceNotFoundException =
  struct
    ...
    let of_json json =
      ...
      make ?message ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Raised when the requested resource cannot be found."]
module ResourceARN =
  struct
    type nonrec t = string
    let context_ = "ResourceARN"
  ...
  struct
    type nonrec t =
      ...
      resourceArn: ResourceARN.t
        [@ocaml.doc "The ARN of the Elastic Inference Accelerator to untag."];
...
module TagResourceRequest =
  struct
    type nonrec t =
      {
      resourceArn: ResourceARN.t
        [@ocaml.doc "The ARN of the Elastic Inference Accelerator to tag."];
      tags: TagMap.t
        [@ocaml.doc "The tags to add to the Elastic Inference Accelerator."]}
  ...
  struct
    type nonrec t =
      ...
      tags: TagMap.t option
        [@ocaml.doc "The tags of the Elastic Inference Accelerator."]}
    type nonrec error =
      [ `BadRequestException of BadRequestException.t 
      | `InternalServerException of InternalServerException.t 
      | `ResourceNotFoundException of ResourceNotFoundException.t 
    ...
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Returns all tags of an Elastic Inference Accelerator."]
  ...
  struct
    type nonrec t =
      ...
      acceleratorSet: ElasticInferenceAcceleratorSet.t option
        [@ocaml.doc "The details of the Elastic Inference Accelerators."];
  ...
  struct
    type nonrec t =
      ...
      acceleratorIds: AcceleratorIdList.t option
        [@ocaml.doc "The IDs of the accelerators to describe."];
  ...
  struct
    type nonrec t =
      ...
      acceleratorTypes: AcceleratorTypeList.t option
        [@ocaml.doc "The available accelerator types."]}
    type nonrec error =
      [ `InternalServerException of InternalServerException.t 
      | `Unknown_operation_error of (string * string option) ]
  ...
  struct
    type nonrec t =
      ...
      acceleratorTypes: AcceleratorTypeNameList.t option
        [@ocaml.doc "The list of accelerator types to describe."]}
