    ...
    ?cfg:Awso.Cfg.t ->
      AssociateDeviceWithRoomRequest.t ->
        (AssociateDeviceWithRoomResponse.t,
          AssociateDeviceWithRoomResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      AssociateSkillWithUsersRequest.t ->
        (AssociateSkillWithUsersResponse.t,
          AssociateSkillWithUsersResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateConferenceProviderRequest.t ->
        (CreateConferenceProviderResponse.t,
          CreateConferenceProviderResponse.error) Result.t
val create_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteConferenceProviderRequest.t ->
        (DeleteConferenceProviderResponse.t,
          DeleteConferenceProviderResponse.error) Result.t
val delete_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDeviceUsageDataRequest.t ->
        (DeleteDeviceUsageDataResponse.t,
          DeleteDeviceUsageDataResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DisassociateDeviceFromRoomRequest.t ->
        (DisassociateDeviceFromRoomResponse.t,
          DisassociateDeviceFromRoomResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DisassociateSkillFromUsersRequest.t ->
        (DisassociateSkillFromUsersResponse.t,
          DisassociateSkillFromUsersResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ForgetSmartHomeAppliancesRequest.t ->
        (ForgetSmartHomeAppliancesResponse.t,
          ForgetSmartHomeAppliancesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetConferencePreferenceRequest.t ->
        (GetConferencePreferenceResponse.t,
          GetConferencePreferenceResponse.error) Result.t
val get_conference_provider :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetConferenceProviderRequest.t ->
        (GetConferenceProviderResponse.t,
          GetConferenceProviderResponse.error) Result.t
val get_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetContactRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetInvitationConfigurationRequest.t ->
        (GetInvitationConfigurationResponse.t,
          GetInvitationConfigurationResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetRoomSkillParameterRequest.t ->
        (GetRoomSkillParameterResponse.t,
          GetRoomSkillParameterResponse.error) Result.t
val get_skill_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListConferenceProvidersRequest.t ->
        (ListConferenceProvidersResponse.t,
          ListConferenceProvidersResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListSkillsStoreCategoriesRequest.t ->
        (ListSkillsStoreCategoriesResponse.t,
          ListSkillsStoreCategoriesResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListSmartHomeAppliancesRequest.t ->
        (ListSmartHomeAppliancesResponse.t,
          ListSmartHomeAppliancesResponse.error) Result.t
val list_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListTagsRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      SearchNetworkProfilesRequest.t ->
        (SearchNetworkProfilesResponse.t,
          SearchNetworkProfilesResponse.error) Result.t
val search_profiles :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateConferenceProviderRequest.t ->
        (UpdateConferenceProviderResponse.t,
          UpdateConferenceProviderResponse.error) Result.t
val update_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
