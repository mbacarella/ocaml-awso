  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ApproveSkillRequest.t ->
        (ApproveSkillResponse.t, ApproveSkillResponse.error) Result.t Lwt.t
val associate_contact_with_address_book :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AssociateContactWithAddressBookRequest.t ->
        (AssociateContactWithAddressBookResponse.t,
          AssociateContactWithAddressBookResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateBusinessReportScheduleRequest.t ->
        (CreateBusinessReportScheduleResponse.t,
          CreateBusinessReportScheduleResponse.error) Result.t Lwt.t
val create_conference_provider :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateConferenceProviderRequest.t ->
        (CreateConferenceProviderResponse.t,
          CreateConferenceProviderResponse.error) Result.t Lwt.t
val create_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteBusinessReportScheduleRequest.t ->
        (DeleteBusinessReportScheduleResponse.t,
          DeleteBusinessReportScheduleResponse.error) Result.t Lwt.t
val delete_conference_provider :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteConferenceProviderRequest.t ->
        (DeleteConferenceProviderResponse.t,
          DeleteConferenceProviderResponse.error) Result.t Lwt.t
val delete_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDeviceUsageDataRequest.t ->
        (DeleteDeviceUsageDataResponse.t,
          DeleteDeviceUsageDataResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetConferencePreferenceRequest.t ->
        (GetConferencePreferenceResponse.t,
          GetConferencePreferenceResponse.error) Result.t Lwt.t
val get_conference_provider :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetConferenceProviderRequest.t ->
        (GetConferenceProviderResponse.t,
          GetConferenceProviderResponse.error) Result.t Lwt.t
val get_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetContactRequest.t ->
...
val get_device :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetDeviceRequest.t ->
        (GetDeviceResponse.t, GetDeviceResponse.error) Result.t Lwt.t
val get_gateway :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetGatewayRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetInvitationConfigurationRequest.t ->
        (GetInvitationConfigurationResponse.t,
          GetInvitationConfigurationResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetRoomSkillParameterRequest.t ->
        (GetRoomSkillParameterResponse.t,
          GetRoomSkillParameterResponse.error) Result.t Lwt.t
val get_skill_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetSkillGroupRequest.t ->
        (GetSkillGroupResponse.t, GetSkillGroupResponse.error) Result.t Lwt.t
val list_business_report_schedules :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListBusinessReportSchedulesRequest.t ->
        (ListBusinessReportSchedulesResponse.t,
          ListBusinessReportSchedulesResponse.error) Result.t Lwt.t
val list_conference_providers :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListConferenceProvidersRequest.t ->
        (ListConferenceProvidersResponse.t,
          ListConferenceProvidersResponse.error) Result.t Lwt.t
...
val list_skills :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListSkillsRequest.t ->
        (ListSkillsResponse.t, ListSkillsResponse.error) Result.t Lwt.t
val list_skills_store_categories :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListSkillsStoreCategoriesRequest.t ->
        (ListSkillsStoreCategoriesResponse.t,
          ListSkillsStoreCategoriesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListSkillsStoreSkillsByCategoryRequest.t ->
        (ListSkillsStoreSkillsByCategoryResponse.t,
          ListSkillsStoreSkillsByCategoryResponse.error) Result.t Lwt.t
val list_smart_home_appliances :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListSmartHomeAppliancesRequest.t ->
        (ListSmartHomeAppliancesResponse.t,
          ListSmartHomeAppliancesResponse.error) Result.t Lwt.t
val list_tags :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListTagsRequest.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RejectSkillRequest.t ->
        (RejectSkillResponse.t, RejectSkillResponse.error) Result.t Lwt.t
val resolve_room :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ResolveRoomRequest.t ->
        (ResolveRoomResponse.t, ResolveRoomResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SearchDevicesRequest.t ->
        (SearchDevicesResponse.t, SearchDevicesResponse.error) Result.t Lwt.t
val search_network_profiles :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SearchNetworkProfilesRequest.t ->
        (SearchNetworkProfilesResponse.t,
          SearchNetworkProfilesResponse.error) Result.t Lwt.t
val search_profiles :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      SearchRoomsRequest.t ->
        (SearchRoomsResponse.t, SearchRoomsResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      StartSmartHomeApplianceDiscoveryRequest.t ->
        (StartSmartHomeApplianceDiscoveryResponse.t,
          StartSmartHomeApplianceDiscoveryResponse.error) Result.t Lwt.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateBusinessReportScheduleRequest.t ->
        (UpdateBusinessReportScheduleResponse.t,
          UpdateBusinessReportScheduleResponse.error) Result.t Lwt.t
val update_conference_provider :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateConferenceProviderRequest.t ->
        (UpdateConferenceProviderResponse.t,
          UpdateConferenceProviderResponse.error) Result.t Lwt.t
val update_contact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
