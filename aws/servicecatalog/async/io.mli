    ...
    ?cfg:Awso.Cfg.t ->
      AssociateBudgetWithResourceInput.t ->
        (AssociateBudgetWithResourceOutput.t,
          AssociateBudgetWithResourceOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateProvisionedProductPlanInput.t ->
        (CreateProvisionedProductPlanOutput.t,
          CreateProvisionedProductPlanOutput.error) Result.t Async.Deferred.t
val create_provisioning_artifact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateProvisioningArtifactInput.t ->
        (CreateProvisioningArtifactOutput.t,
          CreateProvisioningArtifactOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteProvisionedProductPlanInput.t ->
        (DeleteProvisionedProductPlanOutput.t,
          DeleteProvisionedProductPlanOutput.error) Result.t Async.Deferred.t
val delete_provisioning_artifact :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteProvisioningArtifactInput.t ->
        (DeleteProvisioningArtifactOutput.t,
          DeleteProvisioningArtifactOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeCopyProductStatusInput.t ->
        (DescribeCopyProductStatusOutput.t,
          DescribeCopyProductStatusOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribePortfolioShareStatusInput.t ->
        (DescribePortfolioShareStatusOutput.t,
          DescribePortfolioShareStatusOutput.error) Result.t Async.Deferred.t
val describe_portfolio_shares :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribePortfolioSharesInput.t ->
        (DescribePortfolioSharesOutput.t,
          DescribePortfolioSharesOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeProvisionedProductInput.t ->
        (DescribeProvisionedProductOutput.t,
          DescribeProvisionedProductOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeProvisioningArtifactInput.t ->
        (DescribeProvisioningArtifactOutput.t,
          DescribeProvisioningArtifactOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      EnableAWSOrganizationsAccessInput.t ->
        (EnableAWSOrganizationsAccessOutput.t,
          EnableAWSOrganizationsAccessOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListConstraintsForPortfolioInput.t ->
        (ListConstraintsForPortfolioOutput.t,
          ListConstraintsForPortfolioOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListResourcesForTagOptionInput.t ->
        (ListResourcesForTagOptionOutput.t,
          ListResourcesForTagOptionOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ScanProvisionedProductsInput.t ->
        (ScanProvisionedProductsOutput.t,
          ScanProvisionedProductsOutput.error) Result.t Async.Deferred.t
val search_products :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      SearchProvisionedProductsInput.t ->
        (SearchProvisionedProductsOutput.t,
          SearchProvisionedProductsOutput.error) Result.t Async.Deferred.t
val terminate_provisioned_product :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      TerminateProvisionedProductInput.t ->
        (TerminateProvisionedProductOutput.t,
          TerminateProvisionedProductOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateProvisionedProductInput.t ->
        (UpdateProvisionedProductOutput.t,
          UpdateProvisionedProductOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateProvisioningArtifactInput.t ->
        (UpdateProvisioningArtifactOutput.t,
          UpdateProvisioningArtifactOutput.error) Result.t Async.Deferred.t
