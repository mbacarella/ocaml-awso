    ...
    ?cfg:Awso.Cfg.t ->
      DeleteEdgeConfigurationInput.t ->
        (DeleteEdgeConfigurationOutput.t,
          DeleteEdgeConfigurationOutput.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeEdgeConfigurationInput.t ->
        (DescribeEdgeConfigurationOutput.t,
          DescribeEdgeConfigurationOutput.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeSignalingChannelInput.t ->
        (DescribeSignalingChannelOutput.t,
          DescribeSignalingChannelOutput.error) Result.t
val describe_stream :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      StartEdgeConfigurationUpdateInput.t ->
        (StartEdgeConfigurationUpdateOutput.t,
          StartEdgeConfigurationUpdateOutput.error) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      TagResourceInput.t ->
...
val tag_stream :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      TagStreamInput.t -> (TagStreamOutput.t, TagStreamOutput.error) Result.t
val untag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
