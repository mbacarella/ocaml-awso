    ...
    ?cfg:Awso.Cfg.t ->
      CreateSizeConstraintSetRequest.t ->
        (CreateSizeConstraintSetResponse.t,
          CreateSizeConstraintSetResponse.error) Result.t Lwt.t
val create_sql_injection_match_set :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateSqlInjectionMatchSetRequest.t ->
        (CreateSqlInjectionMatchSetResponse.t,
          CreateSqlInjectionMatchSetResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateWebACLMigrationStackRequest.t ->
        (CreateWebACLMigrationStackResponse.t,
          CreateWebACLMigrationStackResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteSizeConstraintSetRequest.t ->
        (DeleteSizeConstraintSetResponse.t,
          DeleteSizeConstraintSetResponse.error) Result.t Lwt.t
val delete_sql_injection_match_set :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteSqlInjectionMatchSetRequest.t ->
        (DeleteSqlInjectionMatchSetResponse.t,
          DeleteSqlInjectionMatchSetResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetRateBasedRuleManagedKeysRequest.t ->
        (GetRateBasedRuleManagedKeysResponse.t,
          GetRateBasedRuleManagedKeysResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetSqlInjectionMatchSetRequest.t ->
        (GetSqlInjectionMatchSetResponse.t,
          GetSqlInjectionMatchSetResponse.error) Result.t Lwt.t
val get_web_a_c_l :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetWebACLRequest.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListActivatedRulesInRuleGroupRequest.t ->
        (ListActivatedRulesInRuleGroupResponse.t,
          ListActivatedRulesInRuleGroupResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateSizeConstraintSetRequest.t ->
        (UpdateSizeConstraintSetResponse.t,
          UpdateSizeConstraintSetResponse.error) Result.t Lwt.t
val update_sql_injection_match_set :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateSqlInjectionMatchSetRequest.t ->
        (UpdateSqlInjectionMatchSetResponse.t,
          UpdateSqlInjectionMatchSetResponse.error) Result.t Lwt.t
