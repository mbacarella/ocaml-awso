...
val allow_custom_routing_traffic :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      AllowCustomRoutingTrafficRequest.t -> (unit, unit) Result.t
...
val delete_accelerator :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteAcceleratorRequest.t -> (unit, unit) Result.t
...
val delete_custom_routing_accelerator :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteCustomRoutingAcceleratorRequest.t -> (unit, unit) Result.t
val delete_custom_routing_endpoint_group :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteCustomRoutingEndpointGroupRequest.t -> (unit, unit) Result.t
val delete_custom_routing_listener :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteCustomRoutingListenerRequest.t -> (unit, unit) Result.t
val delete_endpoint_group :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DeleteEndpointGroupRequest.t -> (unit, unit) Result.t
val delete_listener :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteListenerRequest.t -> (unit, unit) Result.t
val deny_custom_routing_traffic :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      DenyCustomRoutingTrafficRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      DescribeEndpointGroupRequest.t ->
        (DescribeEndpointGroupResponse.t,
          DescribeEndpointGroupResponse.error) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListCustomRoutingListenersRequest.t ->
        (ListCustomRoutingListenersResponse.t,
          ListCustomRoutingListenersResponse.error) Result.t
...
val remove_endpoints :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> RemoveEndpointsRequest.t -> (unit, unit) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
