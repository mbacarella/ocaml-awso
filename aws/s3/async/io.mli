    ...
    ?cfg:Awso.Cfg.t ->
      CompleteMultipartUploadRequest.t ->
        (CompleteMultipartUploadOutput.t,
          CompleteMultipartUploadOutput.error) Result.t Async.Deferred.t
val copy_object :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CopyObjectRequest.t ->
...
val delete_bucket_cors :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteBucketCorsRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val delete_bucket_website :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteBucketWebsiteRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_object :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetBucketOwnershipControlsRequest.t ->
        (GetBucketOwnershipControlsOutput.t,
          GetBucketOwnershipControlsOutput.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetBucketRequestPaymentRequest.t ->
        (GetBucketRequestPaymentOutput.t,
          GetBucketRequestPaymentOutput.error) Result.t Async.Deferred.t
...
val get_object :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetObjectRequest.t ->
        (GetObjectOutput.t, GetObjectOutput.error) Result.t Async.Deferred.t
val get_object_acl :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetObjectLockConfigurationRequest.t ->
        (GetObjectLockConfigurationOutput.t,
          GetObjectLockConfigurationOutput.error) Result.t Async.Deferred.t
...
val put_bucket_acl :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBucketAclRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_bucket_cors :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBucketCorsRequest.t -> (unit, unit) Result.t Async.Deferred.t
val put_bucket_encryption :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBucketEncryptionRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_bucket_lifecycle :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBucketLifecycleRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_bucket_logging :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBucketLoggingRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_bucket_website :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBucketWebsiteRequest.t -> (unit, unit) Result.t Async.Deferred.t
val put_object :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutObjectRequest.t ->
        (PutObjectOutput.t, PutObjectOutput.error) Result.t Async.Deferred.t
val put_object_acl :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      PutObjectLockConfigurationRequest.t ->
        (PutObjectLockConfigurationOutput.t,
          PutObjectLockConfigurationOutput.error) Result.t Async.Deferred.t
