...
val create_branch :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> CreateBranchInput.t -> (unit, unit) Result.t
val create_commit :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      CreateCommitInput.t ->
...
val put_comment_reaction :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> PutCommentReactionInput.t -> (unit, unit) Result.t
val put_file :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
...
val update_default_branch :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      UpdateDefaultBranchInput.t -> (unit, unit) Result.t
...
val update_repository_name :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      UpdateRepositoryNameInput.t -> (unit, unit) Result.t