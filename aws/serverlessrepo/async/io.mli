    ...
    ?cfg:Awso.Cfg.t ->
      CreateApplicationVersionRequest.t ->
        (CreateApplicationVersionResponse.t,
          CreateApplicationVersionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetCloudFormationTemplateRequest.t ->
        (GetCloudFormationTemplateResponse.t,
          GetCloudFormationTemplateResponse.error) Result.t Async.Deferred.t
...
val unshare_application :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UnshareApplicationRequest.t -> (unit, unit) Result.t Async.Deferred.t
