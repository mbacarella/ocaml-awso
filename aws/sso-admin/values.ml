...
module AttachedManagedPolicy =
  struct
    type nonrec t =
      {
      name: Name.t option [@ocaml.doc "The name of the IAM managed policy."];
...
module InstanceMetadata =
  struct
    ...
    let of_json json =
      ...
      make ?identityStoreId ?instanceArn ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Provides information about the SSO instance."]
  ...
  struct
    type nonrec t =
      ...
      inlinePolicy: PermissionSetPolicyDocument.t
        [@ocaml.doc "The IAM inline policy to attach to a PermissionSet."]}
...
module ListPermissionSetsResponse =
  struct
    ...
    let of_json json =
      ...
      make ?nextToken ?permissionSets ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Lists the PermissionSets in an SSO instance."]
  ...
  struct
    type nonrec t =
      ...
      instances: InstanceList.t option
        [@ocaml.doc "Lists the SSO instances that the caller has access to."];
      nextToken: Token.t option
        [@ocaml.doc
          "The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls."]}
    type nonrec error =
    ...
    let of_json json =
      ...
      make ?nextToken ?instances ()
    let to_json v = composed_to_json to_value v
  end[@@ocaml.doc "Lists the SSO instances that the caller has access to."]
