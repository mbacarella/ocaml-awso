  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateIdentityPoolInput.t ->
        (IdentityPool.t, IdentityPool.error) Result.t
...
val delete_identity_pool :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteIdentityPoolInput.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetCredentialsForIdentityInput.t ->
        (GetCredentialsForIdentityResponse.t,
          GetCredentialsForIdentityResponse.error) Result.t
val get_id :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetIdInput.t -> (GetIdResponse.t, GetIdResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      LookupDeveloperIdentityInput.t ->
        (LookupDeveloperIdentityResponse.t,
          LookupDeveloperIdentityResponse.error) Result.t
val merge_developer_identities :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      MergeDeveloperIdentitiesInput.t ->
        (MergeDeveloperIdentitiesResponse.t,
          MergeDeveloperIdentitiesResponse.error) Result.t
val set_identity_pool_roles :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetIdentityPoolRolesInput.t -> (unit, unit) Result.t
...
val unlink_developer_identity :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UnlinkDeveloperIdentityInput.t -> (unit, unit) Result.t
val unlink_identity :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UnlinkIdentityInput.t -> (unit, unit) Result.t
val untag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val update_identity_pool :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      IdentityPool.t -> (IdentityPool.t, IdentityPool.error) Result.t