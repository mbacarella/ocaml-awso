...
val delete_identity_pool :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteIdentityPoolInput.t -> (unit, unit) Result.t
...
val set_identity_pool_roles :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
      SetIdentityPoolRolesInput.t -> (unit, unit) Result.t
...
val unlink_identity :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> UnlinkIdentityInput.t -> (unit, unit) Result.t
val untag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
