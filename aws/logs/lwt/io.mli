    ...
    ?cfg:Awso.Cfg.t ->
      AssociateSourceToS3TableIntegrationRequest.t ->
        (AssociateSourceToS3TableIntegrationResponse.t,
          AssociateSourceToS3TableIntegrationResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateLogAnomalyDetectorRequest.t ->
        (CreateLogAnomalyDetectorResponse.t,
          CreateLogAnomalyDetectorResponse.error) Result.t Lwt.t
...
val delete_account_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAccountPolicyRequest.t -> (unit, unit) Result.t Lwt.t
val delete_data_protection_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDataProtectionPolicyRequest.t -> (unit, unit) Result.t Lwt.t
val delete_delivery :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteDeliveryRequest.t -> (unit, unit) Result.t Lwt.t
val delete_delivery_destination :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliveryDestinationRequest.t -> (unit, unit) Result.t Lwt.t
val delete_delivery_destination_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliveryDestinationPolicyRequest.t -> (unit, unit) Result.t Lwt.t
val delete_delivery_source :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliverySourceRequest.t -> (unit, unit) Result.t Lwt.t
...
val delete_log_anomaly_detector :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLogAnomalyDetectorRequest.t -> (unit, unit) Result.t Lwt.t
...
val delete_lookup_table :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLookupTableRequest.t -> (unit, unit) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDeliveryDestinationsRequest.t ->
        (DescribeDeliveryDestinationsResponse.t,
          DescribeDeliveryDestinationsResponse.error) Result.t Lwt.t
val describe_delivery_sources :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeDeliverySourcesRequest.t ->
        (DescribeDeliverySourcesResponse.t,
          DescribeDeliverySourcesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeImportTaskBatchesRequest.t ->
        (DescribeImportTaskBatchesResponse.t,
          DescribeImportTaskBatchesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeIndexPoliciesRequest.t ->
        (DescribeIndexPoliciesResponse.t,
          DescribeIndexPoliciesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLogAnomalyDetectorRequest.t ->
        (GetLogAnomalyDetectorResponse.t,
          GetLogAnomalyDetectorResponse.error) Result.t Lwt.t
val get_log_events :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetLogFieldsRequest.t ->
        (GetLogFieldsResponse.t, GetLogFieldsResponse.error) Result.t Lwt.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      GetLogObjectRequest.t ->
        (GetLogObjectResponse.t, GetLogObjectResponse.error) Result.t Lwt.t
val get_log_record :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetScheduledQueryHistoryRequest.t ->
        (GetScheduledQueryHistoryResponse.t,
          GetScheduledQueryHistoryResponse.error) Result.t Lwt.t
val get_transformer :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListAggregateLogGroupSummariesRequest.t ->
        (ListAggregateLogGroupSummariesResponse.t,
          ListAggregateLogGroupSummariesResponse.error) Result.t Lwt.t
val list_anomalies :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListAnomaliesRequest.t ->
        (ListAnomaliesResponse.t, ListAnomaliesResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListLogAnomalyDetectorsRequest.t ->
        (ListLogAnomalyDetectorsResponse.t,
          ListLogAnomalyDetectorsResponse.error) Result.t Lwt.t
val list_log_groups :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListLogGroupsRequest.t ->
        (ListLogGroupsResponse.t, ListLogGroupsResponse.error) Result.t Lwt.t
val list_log_groups_for_query :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListLogGroupsForQueryRequest.t ->
        (ListLogGroupsForQueryResponse.t,
          ListLogGroupsForQueryResponse.error) Result.t Lwt.t
    ...
    ?cfg:Awso.Cfg.t ->
      ListSourcesForS3TableIntegrationRequest.t ->
        (ListSourcesForS3TableIntegrationResponse.t,
          ListSourcesForS3TableIntegrationResponse.error) Result.t Lwt.t
...
val put_log_group_deletion_protection :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutLogGroupDeletionProtectionRequest.t -> (unit, unit) Result.t Lwt.t
...
val put_transformer :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> PutTransformerRequest.t -> (unit, unit) Result.t Lwt.t
val start_live_tail :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartLiveTailRequest.t ->
        (StartLiveTailResponse.t, StartLiveTailResponse.error) Result.t Lwt.t
val start_query :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartQueryRequest.t ->
...
val update_anomaly :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> UpdateAnomalyRequest.t -> (unit, unit) Result.t Lwt.t
val update_delivery_configuration :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateDeliveryConfigurationRequest.t ->
        (UpdateDeliveryConfigurationResponse.t,
          UpdateDeliveryConfigurationResponse.error) Result.t Lwt.t
val update_log_anomaly_detector :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateLogAnomalyDetectorRequest.t -> (unit, unit) Result.t Lwt.t
