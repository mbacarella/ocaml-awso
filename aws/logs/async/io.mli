...
val associate_kms_key :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AssociateKmsKeyRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val cancel_export_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CancelExportTaskRequest.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateLogAnomalyDetectorRequest.t ->
        (CreateLogAnomalyDetectorResponse.t,
          CreateLogAnomalyDetectorResponse.error) Result.t Async.Deferred.t
val create_log_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateLogGroupRequest.t -> (unit, unit) Result.t Async.Deferred.t
val create_log_stream :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateLogStreamRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val delete_account_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteAccountPolicyRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_data_protection_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDataProtectionPolicyRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val delete_delivery :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliveryRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_delivery_destination :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliveryDestinationRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val delete_delivery_destination_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliveryDestinationPolicyRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val delete_delivery_source :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDeliverySourceRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val delete_log_anomaly_detector :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLogAnomalyDetectorRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val delete_log_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLogGroupRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_log_stream :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLogStreamRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_lookup_table :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteLookupTableRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_metric_filter :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteMetricFilterRequest.t -> (unit, unit) Result.t Async.Deferred.t
val delete_query_definition :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteQueryDefinitionRequest.t ->
        (DeleteQueryDefinitionResponse.t,
          DeleteQueryDefinitionResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeAccountPoliciesRequest.t ->
        (DescribeAccountPoliciesResponse.t,
          DescribeAccountPoliciesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDeliverySourcesRequest.t ->
        (DescribeDeliverySourcesResponse.t,
          DescribeDeliverySourcesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeImportTaskBatchesRequest.t ->
        (DescribeImportTaskBatchesResponse.t,
          DescribeImportTaskBatchesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeIndexPoliciesRequest.t ->
        (DescribeIndexPoliciesResponse.t,
          DescribeIndexPoliciesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeMetricFiltersRequest.t ->
        (DescribeMetricFiltersResponse.t,
          DescribeMetricFiltersResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeQueryDefinitionsRequest.t ->
        (DescribeQueryDefinitionsResponse.t,
          DescribeQueryDefinitionsResponse.error) Result.t Async.Deferred.t
val describe_resource_policies :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeResourcePoliciesRequest.t ->
        (DescribeResourcePoliciesResponse.t,
          DescribeResourcePoliciesResponse.error) Result.t Async.Deferred.t
...
val disassociate_kms_key :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DisassociateKmsKeyRequest.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetDeliveryDestinationRequest.t ->
        (GetDeliveryDestinationResponse.t,
          GetDeliveryDestinationResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      GetLogAnomalyDetectorRequest.t ->
        (GetLogAnomalyDetectorResponse.t,
          GetLogAnomalyDetectorResponse.error) Result.t Async.Deferred.t
val get_log_events :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      GetScheduledQueryHistoryRequest.t ->
        (GetScheduledQueryHistoryResponse.t,
          GetScheduledQueryHistoryResponse.error) Result.t Async.Deferred.t
val get_transformer :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListLogAnomalyDetectorsRequest.t ->
        (ListLogAnomalyDetectorsResponse.t,
          ListLogAnomalyDetectorsResponse.error) Result.t Async.Deferred.t
val list_log_groups :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      ListLogGroupsForQueryRequest.t ->
        (ListLogGroupsForQueryResponse.t,
          ListLogGroupsForQueryResponse.error) Result.t Async.Deferred.t
...
val put_bearer_token_authentication :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutBearerTokenAuthenticationRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      PutDataProtectionPolicyRequest.t ->
        (PutDataProtectionPolicyResponse.t,
          PutDataProtectionPolicyResponse.error) Result.t Async.Deferred.t
val put_delivery_destination :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutDeliveryDestinationRequest.t ->
        (PutDeliveryDestinationResponse.t,
          PutDeliveryDestinationResponse.error) Result.t Async.Deferred.t
...
val put_destination_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutDestinationPolicyRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_log_group_deletion_protection :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutLogGroupDeletionProtectionRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
val put_metric_filter :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutMetricFilterRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_retention_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutRetentionPolicyRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val put_transformer :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      PutTransformerRequest.t -> (unit, unit) Result.t Async.Deferred.t
val start_live_tail :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val tag_log_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      TagLogGroupRequest.t -> (unit, unit) Result.t Async.Deferred.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val untag_log_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UntagLogGroupRequest.t -> (unit, unit) Result.t Async.Deferred.t
val untag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
...
val update_anomaly :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateAnomalyRequest.t -> (unit, unit) Result.t Async.Deferred.t
...
val update_log_anomaly_detector :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      UpdateLogAnomalyDetectorRequest.t ->
        (unit, unit) Result.t Async.Deferred.t
