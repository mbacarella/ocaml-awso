...
val add_role_to_d_b_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AddRoleToDBClusterMessage.t -> (unit, unit) Result.t
val add_role_to_d_b_instance :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AddRoleToDBInstanceMessage.t -> (unit, unit) Result.t
...
val cancel_export_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CancelExportTaskMessage.t -> (ExportTask.t, ExportTask.error) Result.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateCustomDBEngineVersionMessage.t ->
        (DBEngineVersion.t, DBEngineVersion.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateDBInstanceReadReplicaMessage.t ->
        (CreateDBInstanceReadReplicaResult.t,
          CreateDBInstanceReadReplicaResult.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateDBProxyEndpointRequest.t ->
        (CreateDBProxyEndpointResponse.t,
          CreateDBProxyEndpointResponse.error) Result.t
...
val delete_d_b_parameter_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDBParameterGroupMessage.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDBProxyEndpointRequest.t ->
        (DeleteDBProxyEndpointResponse.t,
          DeleteDBProxyEndpointResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeregisterDBProxyTargetsRequest.t ->
        (DeregisterDBProxyTargetsResponse.t,
          DeregisterDBProxyTargetsResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBInstanceAutomatedBackupsMessage.t ->
        (DBInstanceAutomatedBackupMessage.t,
          DBInstanceAutomatedBackupMessage.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBProxyEndpointsRequest.t ->
        (DescribeDBProxyEndpointsResponse.t,
          DescribeDBProxyEndpointsResponse.error) Result.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeOptionGroupsMessage.t ->
        (OptionGroups.t, OptionGroups.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyDBProxyEndpointRequest.t ->
        (ModifyDBProxyEndpointResponse.t,
          ModifyDBProxyEndpointResponse.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyDBSnapshotAttributeMessage.t ->
        (ModifyDBSnapshotAttributeResult.t,
          ModifyDBSnapshotAttributeResult.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      PromoteReadReplicaDBClusterMessage.t ->
        (PromoteReadReplicaDBClusterResult.t,
          PromoteReadReplicaDBClusterResult.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      RegisterDBProxyTargetsRequest.t ->
        (RegisterDBProxyTargetsResponse.t,
          RegisterDBProxyTargetsResponse.error) Result.t
...
val remove_role_from_d_b_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RemoveRoleFromDBClusterMessage.t -> (unit, unit) Result.t
val remove_role_from_d_b_instance :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RemoveRoleFromDBInstanceMessage.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      RestoreDBInstanceFromS3Message.t ->
        (RestoreDBInstanceFromS3Result.t,
          RestoreDBInstanceFromS3Result.error) Result.t
    ...
    ?cfg:Awso.Cfg.t ->
      RevokeDBSecurityGroupIngressMessage.t ->
        (RevokeDBSecurityGroupIngressResult.t,
          RevokeDBSecurityGroupIngressResult.error) Result.t
...
val start_export_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartExportTaskMessage.t -> (ExportTask.t, ExportTask.error) Result.t
