...
val add_role_to_d_b_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AddRoleToDBClusterMessage.t -> (unit, unit) Result.t Async.Deferred.t
val add_role_to_d_b_instance :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AddRoleToDBInstanceMessage.t -> (unit, unit) Result.t Async.Deferred.t
...
val add_tags_to_resource :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AddTagsToResourceMessage.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      AuthorizeDBSecurityGroupIngressMessage.t ->
        (AuthorizeDBSecurityGroupIngressResult.t,
          AuthorizeDBSecurityGroupIngressResult.error) Result.t
          Async.Deferred.t
val backtrack_d_b_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      BacktrackDBClusterMessage.t ->
        (DBClusterBacktrack.t, DBClusterBacktrack.error) Result.t
          Async.Deferred.t
val cancel_export_task :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CancelExportTaskMessage.t ->
        (ExportTask.t, ExportTask.error) Result.t Async.Deferred.t
val copy_d_b_cluster_parameter_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CopyDBClusterParameterGroupMessage.t ->
        (CopyDBClusterParameterGroupResult.t,
          CopyDBClusterParameterGroupResult.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CopyDBSnapshotMessage.t ->
        (CopyDBSnapshotResult.t, CopyDBSnapshotResult.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateBlueGreenDeploymentRequest.t ->
        (CreateBlueGreenDeploymentResponse.t,
          CreateBlueGreenDeploymentResponse.error) Result.t Async.Deferred.t
val create_custom_d_b_engine_version :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateCustomDBEngineVersionMessage.t ->
        (DBEngineVersion.t, DBEngineVersion.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateDBClusterEndpointMessage.t ->
        (DBClusterEndpoint.t, DBClusterEndpoint.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateDBClusterSnapshotMessage.t ->
        (CreateDBClusterSnapshotResult.t,
          CreateDBClusterSnapshotResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateDBInstanceReadReplicaMessage.t ->
        (CreateDBInstanceReadReplicaResult.t,
          CreateDBInstanceReadReplicaResult.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateDBProxyRequest.t ->
        (CreateDBProxyResponse.t, CreateDBProxyResponse.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateDBProxyEndpointRequest.t ->
        (CreateDBProxyEndpointResponse.t,
          CreateDBProxyEndpointResponse.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateDBShardGroupMessage.t ->
        (DBShardGroup.t, DBShardGroup.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      CreateEventSubscriptionMessage.t ->
        (CreateEventSubscriptionResult.t,
          CreateEventSubscriptionResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteBlueGreenDeploymentRequest.t ->
        (DeleteBlueGreenDeploymentResponse.t,
          DeleteBlueGreenDeploymentResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDBClusterSnapshotMessage.t ->
        (DeleteDBClusterSnapshotResult.t,
          DeleteDBClusterSnapshotResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDBInstanceAutomatedBackupMessage.t ->
        (DeleteDBInstanceAutomatedBackupResult.t,
          DeleteDBInstanceAutomatedBackupResult.error) Result.t
          Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDBProxyRequest.t ->
        (DeleteDBProxyResponse.t, DeleteDBProxyResponse.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeleteDBProxyEndpointRequest.t ->
        (DeleteDBProxyEndpointResponse.t,
          DeleteDBProxyEndpointResponse.error) Result.t Async.Deferred.t
...
val delete_d_b_subnet_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteDBSubnetGroupMessage.t -> (unit, unit) Result.t Async.Deferred.t
val delete_event_subscription :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteEventSubscriptionMessage.t ->
        (DeleteEventSubscriptionResult.t,
          DeleteEventSubscriptionResult.error) Result.t Async.Deferred.t
...
val delete_option_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DeleteOptionGroupMessage.t -> (unit, unit) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DeregisterDBProxyTargetsRequest.t ->
        (DeregisterDBProxyTargetsResponse.t,
          DeregisterDBProxyTargetsResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBClusterAutomatedBackupsMessage.t ->
        (DBClusterAutomatedBackupMessage.t,
          DBClusterAutomatedBackupMessage.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBClusterParameterGroupsMessage.t ->
        (DBClusterParameterGroupsMessage.t,
          DBClusterParameterGroupsMessage.error) Result.t Async.Deferred.t
val describe_d_b_cluster_parameters :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeDBClusterParametersMessage.t ->
        (DBClusterParameterGroupDetails.t,
          DBClusterParameterGroupDetails.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBInstanceAutomatedBackupsMessage.t ->
        (DBInstanceAutomatedBackupMessage.t,
          DBInstanceAutomatedBackupMessage.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBProxyEndpointsRequest.t ->
        (DescribeDBProxyEndpointsResponse.t,
          DescribeDBProxyEndpointsResponse.error) Result.t Async.Deferred.t
val describe_d_b_proxy_target_groups :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeDBProxyTargetGroupsRequest.t ->
        (DescribeDBProxyTargetGroupsResponse.t,
          DescribeDBProxyTargetGroupsResponse.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeDBProxyTargetsRequest.t ->
        (DescribeDBProxyTargetsResponse.t,
          DescribeDBProxyTargetsResponse.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeExportTasksMessage.t ->
        (ExportTasksMessage.t, ExportTasksMessage.error) Result.t
          Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribeOptionGroupsMessage.t ->
        (OptionGroups.t, OptionGroups.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeOrderableDBInstanceOptionsMessage.t ->
        (OrderableDBInstanceOptionsMessage.t,
          OrderableDBInstanceOptionsMessage.error) Result.t Async.Deferred.t
val describe_pending_maintenance_actions :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DescribePendingMaintenanceActionsMessage.t ->
        (PendingMaintenanceActionsMessage.t,
          PendingMaintenanceActionsMessage.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DescribeReservedDBInstancesOfferingsMessage.t ->
        (ReservedDBInstancesOfferingMessage.t,
          ReservedDBInstancesOfferingMessage.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      DownloadDBLogFilePortionMessage.t ->
        (DownloadDBLogFilePortionDetails.t,
          DownloadDBLogFilePortionDetails.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ModifyCurrentDBClusterCapacityMessage.t ->
        (DBClusterCapacityInfo.t, DBClusterCapacityInfo.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyDBClusterParameterGroupMessage.t ->
        (DBClusterParameterGroupNameMessage.t,
          DBClusterParameterGroupNameMessage.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ModifyDBProxyRequest.t ->
        (ModifyDBProxyResponse.t, ModifyDBProxyResponse.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyDBProxyEndpointRequest.t ->
        (ModifyDBProxyEndpointResponse.t,
          ModifyDBProxyEndpointResponse.error) Result.t Async.Deferred.t
val modify_d_b_proxy_target_group :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ModifyDBProxyTargetGroupRequest.t ->
        (ModifyDBProxyTargetGroupResponse.t,
          ModifyDBProxyTargetGroupResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      ModifyDBSnapshotAttributeMessage.t ->
        (ModifyDBSnapshotAttributeResult.t,
          ModifyDBSnapshotAttributeResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      PromoteReadReplicaDBClusterMessage.t ->
        (PromoteReadReplicaDBClusterResult.t,
          PromoteReadReplicaDBClusterResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      PurchaseReservedDBInstancesOfferingMessage.t ->
        (PurchaseReservedDBInstancesOfferingResult.t,
          PurchaseReservedDBInstancesOfferingResult.error) Result.t
          Async.Deferred.t
val reboot_d_b_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RebootDBClusterMessage.t ->
        (RebootDBClusterResult.t, RebootDBClusterResult.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      RegisterDBProxyTargetsRequest.t ->
        (RegisterDBProxyTargetsResponse.t,
          RegisterDBProxyTargetsResponse.error) Result.t Async.Deferred.t
val remove_from_global_cluster :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      RemoveFromGlobalClusterMessage.t ->
        (RemoveFromGlobalClusterResult.t,
          RemoveFromGlobalClusterResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      RestoreDBClusterFromSnapshotMessage.t ->
        (RestoreDBClusterFromSnapshotResult.t,
          RestoreDBClusterFromSnapshotResult.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      RestoreDBInstanceFromDBSnapshotMessage.t ->
        (RestoreDBInstanceFromDBSnapshotResult.t,
          RestoreDBInstanceFromDBSnapshotResult.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      RevokeDBSecurityGroupIngressMessage.t ->
        (RevokeDBSecurityGroupIngressResult.t,
          RevokeDBSecurityGroupIngressResult.error) Result.t Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StartDBInstanceMessage.t ->
        (StartDBInstanceResult.t, StartDBInstanceResult.error) Result.t
          Async.Deferred.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      StopDBInstanceMessage.t ->
        (StopDBInstanceResult.t, StopDBInstanceResult.error) Result.t
          Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      SwitchoverGlobalClusterMessage.t ->
        (SwitchoverGlobalClusterResult.t,
          SwitchoverGlobalClusterResult.error) Result.t Async.Deferred.t
