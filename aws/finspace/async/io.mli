    ...
    ?cfg:Awso.Cfg.t ->
      GetKxConnectionStringRequest.t ->
        (GetKxConnectionStringResponse.t,
          GetKxConnectionStringResponse.error) Result.t Async.Deferred.t
val get_kx_database :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateKxClusterDatabasesRequest.t ->
        (UpdateKxClusterDatabasesResponse.t,
          UpdateKxClusterDatabasesResponse.error) Result.t Async.Deferred.t
    ...
    ?cfg:Awso.Cfg.t ->
      UpdateKxEnvironmentNetworkRequest.t ->
        (UpdateKxEnvironmentNetworkResponse.t,
          UpdateKxEnvironmentNetworkResponse.error) Result.t Async.Deferred.t
val update_kx_user :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
