...
val associate_member_account :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      AssociateMemberAccountRequest.t -> (unit, unit) Result.t
...
val disassociate_member_account :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DisassociateMemberAccountRequest.t -> (unit, unit) Result.t
val disassociate_s3_resources :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      DisassociateS3ResourcesRequest.t ->
        (DisassociateS3ResourcesResult.t,
          DisassociateS3ResourcesResult.error) Result.t
  ...
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      ListS3ResourcesRequest.t ->
        (ListS3ResourcesResult.t, ListS3ResourcesResult.error) Result.t
