    ...
    ?cfg:Awso_eio.Cfg.t ->
      CreateComponentVersionRequest.t ->
        (CreateComponentVersionResponse.t,
          CreateComponentVersionResponse.error) Result.t
...
val delete_component :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteComponentRequest.t -> (unit, unit) Result.t
val delete_core_device :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t -> DeleteCoreDeviceRequest.t -> (unit, unit) Result.t
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ListComponentVersionsRequest.t ->
        (ListComponentVersionsResponse.t,
          ListComponentVersionsResponse.error) Result.t
val list_components :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
    ...
    ?cfg:Awso_eio.Cfg.t ->
      ResolveComponentCandidatesRequest.t ->
        (ResolveComponentCandidatesResponse.t,
          ResolveComponentCandidatesResponse.error) Result.t
val tag_resource :
  ?endpoint_url:string ->
    ?cfg:Awso_eio.Cfg.t ->
