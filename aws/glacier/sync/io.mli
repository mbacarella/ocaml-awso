...
val abort_multipart_upload :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AbortMultipartUploadInput.t -> (unit, unit) Result.t
val abort_vault_lock :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AbortVaultLockInput.t -> (unit, unit) Result.t
val add_tags_to_vault :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> AddTagsToVaultInput.t -> (unit, unit) Result.t
...
val complete_vault_lock :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> CompleteVaultLockInput.t -> (unit, unit) Result.t
val create_vault :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
      CreateVaultInput.t ->
...
val delete_archive :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteArchiveInput.t -> (unit, unit) Result.t
val delete_vault :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> DeleteVaultInput.t -> (unit, unit) Result.t
...
val remove_tags_from_vault :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> RemoveTagsFromVaultInput.t -> (unit, unit) Result.t
val set_data_retrieval_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetDataRetrievalPolicyInput.t -> (unit, unit) Result.t
val set_vault_access_policy :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetVaultAccessPolicyInput.t -> (unit, unit) Result.t
val set_vault_notifications :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t -> SetVaultNotificationsInput.t -> (unit, unit) Result.t
val upload_archive :
  ?endpoint_url:string ->
    ?cfg:Awso.Cfg.t ->
