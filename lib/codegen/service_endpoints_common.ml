    ...
    let to_request (type i) (type o) (type e) (endp : (i, o, e) t) (req : i) =
      ...
      | Name1 ->
          ...
          let body =
            ...
            let query = (Name1.to_query req) |> Awso.Client.Query.render in
      ...
      | Name2 ->
          ...
          let body =
            ...
            let query = (Name2.to_query req) |> Awso.Client.Query.render in
            Some (Uri.encoded_of_query (meta @ query)) in
          Awso.Http.Request.make ?body ~headers (method_of_endpoint endp)
      | Name3 ->
          let headers =
          ...
          let body =
            ...
            let query = (Name3.to_query req) |> Awso.Client.Query.render in
            Some (Uri.encoded_of_query (meta @ query)) in
          Awso.Http.Request.make ?body ~headers (method_of_endpoint endp) |}]
;;
